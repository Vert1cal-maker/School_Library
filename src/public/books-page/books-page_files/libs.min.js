if (
  ((function (e, t) {
    ...
    function d() {
      G.removeEventListener("DOMContentLoaded", d),
              ...
              "" === i.style.display &&
                ...
                (c[u] =
                  ...
                  (l = qe[s]) ||
                    ...
                    "none" === l && (l = "block"),
                    (qe[s] = l)))))
            : "none" !== n && ((c[u] = "none"), De.set(i, "display", n)));
    ...
    function b(e, t, n, r, o) {
      for (
        ...
        if ((a = e[h]) || 0 === a)
          if ("object" === i(a)) he.merge(f, a.nodeType ? [a] : a);
          else if (Ye.test(a)) {
            for (
              s = s || p.appendChild(t.createElement("div")),
                l = (Ze.exec(a) || ["", ""])[1].toLowerCase(),
                c = Xe[l] || Xe._default,
                s.innerHTML = c[1] + he.htmlPrefilter(a) + c[2],
                d = c[0];
              d--;
      ...
      for (p.textContent = "", h = 0; (a = f[h++]); )
        if (r && -1 < he.inArray(a, r)) o && o.push(a);
        else if (
          ((u = Re(a)), (s = y(p.appendChild(a), "script")), u && w(s), n)
        )
          ...
          he.event.add(e, t, {
            ...
            handler: function (e) {
              ...
              if (1 & e.isTrigger && this[t]) {
                if (o.length)
                  (he.event.special[t] || {}).delegateType &&
                    e.stopPropagation();
                else if (
                  ((o = ee.call(arguments)),
                  De.set(this, t, o),
        ...
        if (
          ...
          for (r in (delete a.handle, (a.events = {}), c))
            for (n = 0, i = c[r].length; n < i; n++)
              he.event.add(t, r, c[r][n]);
        Fe.hasData(e) &&
          ((s = Fe.access(e)), (l = he.extend({}, s)), Fe.set(t, l));
      }
    }
    function $(e, t, i, r) {
      t = te.apply([], t);
      ...
      if (
        p &&
        ((a = (o = b(t, e[0].ownerDocument, !1, e, r)).firstChild),
        1 === o.childNodes.length && (o = a),
        a || r)
      ) {
        for (l = (s = he.map(y(o, "script"), k)).length; d < p; d++)
          (c = o),
            d !== f &&
              ((c = he.clone(c, !0, !0)), l && he.merge(s, y(c, "script"))),
            i.call(e[d], c, d);
        if (l)
          for (
            u = s[s.length - 1].ownerDocument, he.map(s, A), d = 0;
            d < l;
            d++
          )
            (c = s[d]),
              Ve.test(c.type || "") &&
                ...
                (c.src && "module" !== (c.type || "").toLowerCase()
                  ...
                  : n(c.textContent.replace(rt, ""), c, u));
      }
      return e;
    }
    function P(e, t, n) {
    ...
    function N(e, t, n, i, r, o) {
      ...
      for (; a < 4; a += 2)
        "margin" === n && (l += he.css(e, n + Le[a], !0, r)),
          i
            ? ("content" === n && (l -= he.css(e, "padding" + Le[a], !0, r)),
              "margin" !== n &&
                (l -= he.css(e, "border" + Le[a] + "Width", !0, r)))
            : ((l += he.css(e, "padding" + Le[a], !0, r)),
              "padding" !== n
                ? (l += he.css(e, "border" + Le[a] + "Width", !0, r))
                : (s += he.css(e, "border" + Le[a] + "Width", !0, r)));
      return (
        !i &&
          0 <= o &&
          (l +=
    ...
    function z(e, t, n) {
      ...
      return (
        ((!ce.boxSizingReliable() && r) ||
          "auto" === a ||
          (!parseFloat(a) && "inline" === he.css(e, "display", !1, i))) &&
          e.getClientRects().length &&
          ((r = "border-box" === he.css(e, "boxSizing", !1, i)),
          (o = s in e) && (a = e[s])),
        (a = parseFloat(a) || 0) +
          N(e, t, n || (r ? "border" : "content"), o, i, a) +
          "px"
      );
    }
    ...
    function H(e, t, n) {
      ...
      for (
        ...
        if ((i = H.prefilters[o].call(c, e, u, c.opts)))
          return (
            ue(i.stop) &&
    ...
    (he.fn = he.prototype =
            ...
            if (null != (e = arguments[s]))
              for (t in e)
                (i = e[t]),
                  "__proto__" !== t &&
                    a !== i &&
                    (c && i && (he.isPlainObject(i) || (r = Array.isArray(i)))
                      ? ((n = a[t]),
                        (o =
                          r && !Array.isArray(n)
                            ? []
                            : r || he.isPlainObject(n)
                            ? n
                            : {}),
                        (r = !1),
                        (a[t] = he.extend(c, o, i)))
      ...
      "function" == typeof Symbol &&
        (he.fn[Symbol.iterator] = Y[Symbol.iterator]),
      he.each(
    ...
    var ge = (function (e) {
      function t(e, t, n, i) {
        ...
        if (
          !i &&
          ((t ? t.ownerDocument || t : M) !== P && $(t), (t = t || P), F)
        ) {
          if (11 !== h && (l = ve.exec(e)))
            if ((r = l[1])) {
              if (9 === h) {
              ...
              if (l) {
                ...
                for (; (t = t[i]); )
                  if (1 === t.nodeType || a)
                    if (
                      ((u =
                        (d = t[L] || (t[L] = {}))[t.uniqueID] ||
                        (d[t.uniqueID] = {})),
                      r && r === t.nodeName.toLowerCase())
                    )
                      t = t[i] || t;
                    else {
                      if ((c = u[o]) && c[0] === R && c[1] === s)
                        return (p[2] = c[2]);
        ...
        return (
          ...
          i(function (i, s, l, c) {
            var u,
              ...
              y = !e || (!i && n) ? v : g(v, f, e, l, c),
              w = r ? (a || (i ? e : m || o) ? [] : s) : y;
            if ((r && r(y, w, l, c), o))
              for (u = g(w, h), o(u, [], l, c), d = u.length; d--; )
                (p = u[d]) && (w[h[d]] = !(y[h[d]] = p));
            if (i) {
              if (a || e) {
                if (a) {
      ...
      try {
        Y.apply((X = G.call(M.childNodes)), M.childNodes),
        ...
        function (e) {
          ...
          return (
            i !== P &&
              ...
              (b.getElementsByClassName = ge.test(P.getElementsByClassName)),
              ...
              (O = []),
              (j = []),
              (b.qsa = ge.test(P.querySelectorAll)) &&
                (r(function (e) {
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!b.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === P || (e.ownerDocument === M && z(M, e))
                          ? -1
                          : t === P || (t.ownerDocument === M && z(M, t))
                          ? 1
                          : A
                          ? J(A, e) - J(A, t)
                          : 0
      ...
      return (
        ...
        (S = t.compile =
          function (e, n) {
            var r,
              ...
              p = q[e + " "];
            if (!p) {
              for (n || (n = T(e)), r = n.length; r--; )
                (p = y(n[r]))[L] ? u.push(p) : d.push(p);
              (p = q(
                e,
                ((o = d),
                (s = 0 < (a = u).length),
          ...
          function (e, t, n, i) {
            ...
            if (((n = n || []), 1 === u.length)) {
              if (
                ...
                if (
                  !(t = (C.find.ID(a.matches[0].replace(we, be), t) || [])[0])
                )
                  return n;
        ...
        (b.sortStable = L.split("").sort(Z).join("") === L),
      ...
      if (((n = n || Ce), "string" == typeof e)) {
        ...
        if (i[1]) {
          if (
            ...
            he.merge(
              this,
              he.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : G, !0)
            ),
        ...
        return (
          (r = G.getElementById(i[2])) && ((this[0] = r), (this.length = 1)),
          this
        );
      }
      return e.nodeType
        ...
        function (e, t) {
          he.fn[e] = function (n, i) {
            ...
            return (
              ...
              1 < this.length &&
                (Te[e] || he.uniqueSort(r), _e.test(e) && r.reverse()),
              this.pushStack(r)
            );
          };
        }
    ...
    (he.Callbacks = function (e) {
      ...
      e =
        "string" == typeof e
          ? ((t = e),
            (n = {}),
            he.each(t.match(Se) || [], function (e, t) {
              n[t] = !0;
            }),
            n)
          : he.extend({}, e);
      var r,
        ...
        u = -1,
        d = function () {
          for (s = s || e.once, a = r = !0; c.length; u = -1)
            for (o = c.shift(); ++u < l.length; )
              !1 === l[u].apply(o[0], o[1]) &&
                e.stopOnFalse &&
                ((u = l.length), (o = !1));
        ...
        p = {
          add: function () {
            return (
              l &&
                (o && !r && ((u = l.length - 1), c.push(o)),
                (function t(n) {
                  he.each(n, function (n, r) {
                    ue(r)
                      ? (e.unique && p.has(r)) || l.push(r)
          ...
          var n = [
            ...
            r = {
              ...
              then: function (t, i, r) {
                ...
                return he
                  .Deferred(function (e) {
                    n[0][3].add(o(0, e, ue(r) ? r : l, e.notifyWith)),
                      n[1][3].add(o(0, e, ue(t) ? t : l)),
                      n[2][3].add(o(0, e, ue(i) ? i : c));
                  })
                  .promise();
              },
              promise: function (e) {
        ...
        when: function (e) {
          var t = arguments.length,
            ...
            a = function (e) {
              return function (n) {
                (i[e] = this),
                  (r[e] = 1 < arguments.length ? ee.call(arguments) : n),
                  --t || o.resolveWith(i, r);
              };
            };
          if (
            ...
            "pending" === o.state() || ue(r[n] && r[n].then))
          )
            return o.then();
    ...
    (he.fn.ready = function (e) {
      ...
      ("loading" !== G.readyState && !G.documentElement.doScroll)
        ...
        : (G.addEventListener("DOMContentLoaded", d),
    ...
    var Ae = function (e, t, n, r, o, a, s) {
        var l = 0,
          ...
          u = null == n;
        if ("object" === i(n))
          for (l in ((o = !0), n)) Ae(e, t, l, n[l], !0, a, s);
        else if (
          void 0 !== r &&
          ((o = !0),
          ue(r) || (s = !0),
      ...
      he.fn.extend({
        data: function (e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((r = Fe.get(o)), 1 === o.nodeType && !De.get(o, "hasDataAttrs"))
            ) {
              for (n = a.length; n--; )
                a[n] &&
                  0 === (i = a[n].name).indexOf("data-") &&
                  ((i = f(i.slice(5))), m(o, i, r[i]));
        ...
        queue: function (e, t, n) {
          ...
          if (e)
            return (
              ...
              n &&
                (!i || Array.isArray(n)
                  ? (i = De.access(e, t, he.makeArray(n)))
                  : i.push(n)),
              i || []
            );
        },
    ...
    var Ue = function (e, t) {
        return (
          ...
          ("" === e.style.display && Re(e) && "none" === he.css(e, "display"))
        );
      },
      He = function (e, t, n, i) {
        var r,
    ...
    var Qe,
      Ke,
      Ye = /<|&#?\w+;/;
    (Qe = G.createDocumentFragment().appendChild(G.createElement("div"))),
      (Ke = G.createElement("input")).setAttribute("type", "radio"),
        ...
        if (g)
          for (
            n.handler && ((n = (o = n).handler), (r = o.selector)),
              r && he.find.matchesSelector(Me, r),
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e;
            return (
              We.test(t.type) && t.click && o(t, "input") && S(t, "click", C),
              !1
            );
          },
          trigger: function (e) {
            var t = this || e;
            return (
              We.test(t.type) && t.click && o(t, "input") && S(t, "click"), !0
            );
          },
          _default: function (e) {
            var t = e.target;
    ...
    he.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (a = y(u), i = 0, r = (o = y(e)).length; i < r; i++)
            (s = o[i]),
              (l = a[i]),
              "input" === (c = l.nodeName.toLowerCase()) && We.test(s.type)
                ? (l.checked = s.checked)
                : ("input" !== c && "textarea" !== c) ||
                  (l.defaultValue = s.defaultValue);
        if (t)
          if (n)
            for (o = o || y(e), a = a || y(u), i = 0, r = o.length; i < r; i++)
              I(o[i], a[i]);
          else I(e, u);
      ...
      cleanData: function (e) {
        for (
          var t, n, i, r = he.event.special, o = 0;
          void 0 !== (n = e[o]);
          o++
        )
          if (Pe(n)) {
            if ((t = n[De.expando])) {
              if (t.events)
                for (i in t.events)
                  r[i] ? he.event.remove(n, i) : he.removeEvent(n, i, t.handle);
              n[De.expando] = void 0;
            }
        ...
        he.cssHooks[t] = {
          ...
          set: function (e, n, i) {
            var r,
              ...
              s = (a || i) && "border-box" === he.css(e, "boxSizing", !1, o),
              l = i ? N(e, t, i, s, o) : 0;
            return (
              s &&
                a &&
          ...
          return Ae(
            ...
            function (e, t, n) {
              var i,
                ...
                a = 0;
              if (Array.isArray(t)) {
                for (i = at(e), r = t.length; a < r; a++)
                  o[t[a]] = he.css(e, t[a], !1, i);
                return o;
              }
        ...
        _default: {
          ...
          set: function (e) {
            he.fx.step[e.prop]
              ? he.fx.step[e.prop](e)
              : 1 !== e.elem.nodeType ||
                (!he.cssHooks[e.prop] && null == e.elem.style[j(e.prop)])
              ? (e.elem[e.prop] = e.now)
    ...
    (he.Animation = he.extend(H, {
        ...
        function (e, t, n) {
          ...
          if ((l = !he.isEmptyObject(t)) || !he.isEmptyObject(f))
            for (i in (d &&
              ...
              null == (c = g && g.display) && (c = De.get(e, "display")),
              "none" === (u = he.css(e, "display")) &&
                (c
                  ? (u = c)
                  : (v([e], !0),
                    (c = e.style.display || c),
            ...
            f))
              l ||
                (g
                  ...
                  : (g = De.access(e, "fxshow", { display: c })),
                o && (g.hidden = !m),
                m && v([e], !0),
                p.done(function () {
                  for (i in (m || v([e]), De.remove(e, "fxshow"), f))
                    he.style(e, i, f[i]);
                })),
                (l = U(m ? g[i] : 0, i, p)),
                i in g ||
        ...
        stop: function (e, t, n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (r in a) a[r] && a[r].stop && bt.test(r) && i(a[r]);
              for (r = o.length; r--; )
                o[r].elem !== this ||
                  (null != e && o[r].queue !== e) ||
      ...
      (vt = G.createElement("input")),
      (yt = G.createElement("select").appendChild(G.createElement("option"))),
      (vt.type = "checkbox"),
      (ce.checkOn = "" !== vt.value),
      (ce.optSelected = yt.selected),
      ((vt = G.createElement("input")).value = "t"),
      (vt.type = "radio"),
      (ce.radioValue = "t" === vt.value);
    var Ct,
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === o && he.isXMLDoc(e)) ||
                  (r =
                    ...
                    (he.expr.match.bool.test(t) ? Ct : void 0)),
                void 0 !== n
                  ? null === n
      ...
      he.extend({
        prop: function (e, t, n) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return (
              (1 === o && he.isXMLDoc(e)) ||
                ((t = he.propFix[t] || t), (r = he.propHooks[t])),
              void 0 !== n
                ? r && "set" in r && void 0 !== (i = r.set(e, n, t))
                  ? i
                  : (e[t] = n)
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : _t.test(e.nodeName) || (Tt.test(e.nodeName) && e.href)
                ? 0
                : -1;
            },
          },
        ...
        toggleClass: function (e, t) {
          ...
          return "boolean" == typeof t && i
            ...
            : this.each(function () {
                var t, r, o, a;
                if (i)
                  for (r = 0, o = he(this), a = Z(e); (t = a[r++]); )
                    o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else
                  (void 0 !== e && "boolean" !== n) ||
                    ((t = W(this)) && De.set(this, "__className__", t),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
                        t || !1 === e ? "" : De.get(this, "__className__") || ""
                      ));
              });
        },
        hasClass: function (e) {
          var t,
            ...
            i = 0;
          for (t = " " + e + " "; (n = this[i++]); )
            if (1 === n.nodeType && -1 < (" " + q(W(n)) + " ").indexOf(t))
              return !0;
          return !1;
        },
      });
        ...
        return arguments.length
          ? ((i = ue(e)),
            this.each(function (n) {
              var r;
              1 === this.nodeType &&
                (null == (r = i ? e.call(this, n, he(this).val()) : e)
                  ? (r = "")
                  : "number" == typeof r
                  ? (r += "")
                  : Array.isArray(r) &&
          ...
          : r
          ? (t =
              he.valHooks[r.type] || he.valHooks[r.nodeName.toLowerCase()]) &&
            "get" in t &&
      ...
      he.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (e, t) {
              for (
                var n, i, r = e.options, o = he.makeArray(t), a = r.length;
                a--;

              )
                ((i = r[a]).selected =
                  -1 < he.inArray(he.valHooks.option.get(i), o)) && (n = !0);
      ...
      trigger: function (t, n, i, r) {
        ...
        if (
          ...
          3 !== i.nodeType &&
            ...
            (-1 < h.indexOf(".") &&
              ((h = (m = h.split(".")).shift()), m.sort()),
            (c = h.indexOf(":") < 0 && "on" + h),
            ((t = t[he.expando]
              ? t
              : new he.Event(h, "object" == typeof t && t)).isTrigger = r
              ? 2
              : 3),
            (t.namespace = m.join(".")),
          ...
          if (!r && !d.noBubble && !de(i)) {
            for (
              l = d.delegateType || h, Et.test(l + h) || (a = a.parentNode);
              a;
              a = a.parentNode
            )
              f.push(a), (s = a);
        ...
        he.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
          ...
          he.event.special[t] = {
            ...
            teardown: function () {
              ...
              r
                ? De.access(i, t, r)
                : (i.removeEventListener(e, n, !0), De.remove(i, t));
            },
          };
        });
    var At = e.location,
        ...
        ajax: function (t, n) {
          function i(t, n, i, s) {
            ...
            u ||
              ...
              c
                ? (h.ifModified &&
                    ((C = _.getResponseHeader("Last-Modified")) &&
                      (he.lastModified[o] = C),
                    (C = _.getResponseHeader("etag")) && (he.etag[o] = C)),
                  204 === t || "HEAD" === h.type
                    ? (x = "nocontent")
                    : 304 === t
                    ? (x = "notmodified")
                    : ((x = b.state), (p = b.data), (c = !(f = b.error))))
                : ((f = x), (!t && x) || ((x = "error"), t < 0 && (t = 0))),
              (_.status = t),
              (_.statusText = (n || x) + ""),
              c ? v.resolveWith(m, [p, x, _]) : v.rejectWith(m, [_, x, f]),
              _.statusCode(w),
              (w = void 0),
              d &&
                g.trigger(c ? "ajaxSuccess" : "ajaxError", [_, h, c ? p : f]),
              y.fireWith(m, [_, x]),
              d &&
          ...
          h.ifModified &&
            (he.lastModified[o] &&
              _.setRequestHeader("If-Modified-Since", he.lastModified[o]),
            he.etag[o] && _.setRequestHeader("If-None-Match", he.etag[o])),
          ...
          if (h.beforeSend && (!1 === h.beforeSend.call(m, _, h) || u))
            return _.abort();
          if (
            ((x = "abort"),
            y.add(h.complete),
            ...
            if (((_.readyState = 1), d && g.trigger("ajaxSend", [_, h]), u))
              return _;
            h.async &&
              0 < h.timeout &&
    ...
    he.ajaxSetup({
      ...
      (he.fn.load = function (e, t, n) {
        var i,
          ...
          s = e.indexOf(" ");
        return (
          -1 < s && ((i = q(e.slice(s))), (e = e.slice(0, s))),
          ue(t)
            ? ((n = t), (t = void 0))
          ...
          if (this[0]) {
            ...
            if ("fixed" === he.css(i, "position"))
              ...
              e &&
                e !== i &&
                1 === e.nodeType &&
                (((r = he(e).offset()).top += he.css(e, "borderTopWidth", !0)),
                (r.left += he.css(e, "borderLeftWidth", !0)));
            }
            return {
          ...
          he.fn[e] = function (i) {
            return Ae(
              ...
              function (e, i, r) {
                var o;
                if (
                  (de(e) ? (o = e) : 9 === e.nodeType && (o = e.defaultView),
                  void 0 === r)
                )
                  return o ? o[t] : e[i];
                o
      ...
      he.each(["top", "left"], function (e, t) {
        he.cssHooks[t] = F(ce.pixelPosition, function (e, n) {
          if (n)
            return (n = D(e, t)), ot.test(n) ? he(e).position()[t] + "px" : n;
        });
      }),
    ...
    return (
      (he.noConflict = function (t) {
        return (
          e.$ === he && (e.$ = Yt), t && e.jQuery === he && (e.jQuery = Kt), he
        );
      }),
      t || (e.jQuery = e.$ = he),
      he
        ...
        (t.content = e),
          e
            ? t.st.showCloseBtn &&
              t.st.closeBtnInside &&
              !0 === t.currTemplate[n]
              ? t.content.find(".mfp-close").length || t.content.append(_())
              : (t.content = e)
            : (t.content = ""),
          x("BeforeAppend"),
        ...
        getInline: function (n, i) {
          if (($(), n.src)) {
            ...
            if (o.length) {
              ...
              a &&
                a.tagName &&
                (k || ((E = r.hiddenClass), (k = C(E)), (E = "mfp-" + E)),
                (A = o.after(k).detach().removeClass(E))),
          ...
          return (
            ...
            !(!n || !n.enabled) &&
              ...
              b("UpdateStatus" + r, function (e, n) {
                n.text &&
                  (n.text = H(n.text, t.currItem.index, t.items.length));
              }),
  ...
  (function (e) {
    ...
    (e.fn.dropdown = function (t) {
      ...
      e(document)
        ...
        .on("click.bs.dropdown.data-api", i, r.prototype.toggle)
        .on("keydown.bs.dropdown.data-api", i, r.prototype.keydown)
        .on(
  ...
  (function (e) {
    ...
    function t(t, n) {
      ...
      if (-1 !== e.inArray(i, n))
        return (
          -1 === e.inArray(i, r) ||
          Boolean(t.nodeValue.match(a) || t.nodeValue.match(s))
        );
      for (
        var o = e(n).filter(function (e, t) {
    ...
    function n(n, i, r) {
      ...
      for (
        ...
        if (-1 !== e.inArray(d, a))
          for (
            var p = e.map(u.attributes, function (e) {
                return e;
              }),
              f = [].concat(i["*"] || [], i[d] || []),
              h = 0,
            ...
            t(p[h], f) || u.removeAttribute(p[h].nodeName);
    ...
    (l.VERSION = "3.4.1"),
      ...
      (l.prototype.getOptions = function (t) {
        ...
        for (var o in r)
          r.hasOwnProperty(o) && -1 !== e.inArray(o, i) && delete r[o];
        return (
          (t = e.extend({}, this.getDefaults(), r, t)).delay &&
      ...
      (l.prototype.getViewportAdjustedDelta = function (e, t, n, i) {
        ...
        if (/right|left/.test(e)) {
          ...
          c < a.left
            ? (r.left = a.left - c)
            : u > a.right && (r.left = a.left + a.width - u);
        }
        return r;
      }),
    ...
    (t.VERSION = "3.4.1"),
      ...
      (t.prototype.process = function () {
        var e,
          ...
          o = this.targets,
          a = this.activeTarget;
        if ((this.scrollHeight != n && this.refresh(), i <= t))
    ...
    (a.version = "0.7.2"),
      ...
      (a._apply = function (t, n) {
        ...
        return (
          ...
          a._maintainScroll &&
            e(window).scrollTop((u / d) * e("html").outerHeight(!0)),
          this
        );
      }),
  ...
  (function (e) {
    ...
    (e.fn.fileinputLocales = {}),
      ...
      (String.prototype.setTokens = function (e) {
        ...
        for (t in e)
          e.hasOwnProperty(t) &&
            ((n = new RegExp("{" + t + "}", "g")), (i = i.replace(n, e[t])));
        return i;
      });
    var t, n;
    (t = {
        ...
        return (
          ...
          (10 === e
            ...
            : ((t = document.createElement("div")),
              ...
              (n = t.getElementsByTagName("i").length),
      ...
      getDragDropFolders: function (e) {
        var t,
          ...
          i = e ? e.length : 0,
          r = 0;
        if (i > 0 && e[0].webkitGetAsEntry())
          for (t = 0; i > t; t++)
            (n = e[t].webkitGetAsEntry()) && n.isDirectory && r++;
        return r;
      },
      ...
      spliceArray: function (t, n, i) {
        ...
        for (
          o = e.extend(!0, [], t), i && o.reverse(), r = 0;
          r < o.length;
          r++
        )
          r !== n && ((s[a] = o[r]), a++);
      ...
      dataURI2Blob: function (e) {
        var n,
          ...
          c = t.hasBlobSupport();
        if (
          !((c || l) && window.atob && window.ArrayBuffer && window.Uint8Array)
        )
          return null;
        for (
          n =
        ...
        return (
          ...
          c
            ? new Blob([t.hasArrayBufferViewSupport() ? r : i], { type: a })
            : ((s = new l()), s.append(i), s.getBlob(a))
        );
      },
      arrayBuffer2String: function (e) {
        ...
        var t,
          ...
          i,
          r,
          o = Array.prototype.slice.apply(new Uint8Array(e)),
          a = "",
          s = 0;
        for (t = o.length; t > s; )
          switch ((n = o[s++]) >> 4) {
      ...
      isHtml: function (e) {
        ...
        t.innerHTML = e;
        for (var n = t.childNodes, i = n.length; i--; )
          if (1 === n[i].nodeType) return !0;
        return !1;
      },
      isSvg: function (e) {
        return (
      ...
      moveArray: function (t, n, i, r) {
        var o = e.extend(!0, [], t);
        if ((r && o.reverse(), i >= o.length))
          for (var a = i - o.length; 1 + a--; ) o.push(void 0);
      ...
      setImageOrientation: function (e, n, i) {
        if (e && e.length) {
          ...
          e.off(r).on(r, function () {
            var r = e.get(0),
              o = n && n.length ? n.get(0) : null,
              a = r.offsetHeight,
              s = r.offsetWidth,
              l = t.getRotation(i);
            if (
              (e.data("orientation", i), o && n.data("orientation", i), 5 > i)
            )
              return t.setTransform(r, l), void t.setTransform(o, l);
            var c = Math.atan(s / a),
              u = Math.sqrt(Math.pow(a, 2) + Math.pow(s, 2)),
              d = u ? a / Math.cos(Math.PI / 2 + c) / u : 1,
              p = " scale(" + Math.abs(d) + ")";
      ...
      (n = function (n, i) {
        ...
        (r.$element = e(n)),
          ...
          r._validate() &&
            ...
            (r.isIE9 = t.isIE(9)),
            (r.isIE10 = t.isIE(10)),
            (r.isPreviewable || r.isIE9) && (r._init(i), r._listen()),
      ...
      (n.prototype = {
        ...
        _init: function (n, i) {
          ...
          (l.options = n),
            ...
            i || l._cleanup(),
            (l.$form = c.closest("form")),
            l._initTemplateDefaults(),
            (l.uploadFileAttr = t.isEmpty(c.attr("name"))
              ? "file_data"
              : c.attr("name")),
            (a = l._getLayoutTemplate("progress")),
            (l.progressTemplate = a.replace("{class}", l.progressClass)),
            (l.progressCompleteTemplate = a.replace(
              "{class}",
              l.progressCompleteClass
            )),
            (l.progressErrorTemplate = a.replace(
              "{class}",
              l.progressErrorClass
            )),
            (l.isDisabled = c.attr("disabled") || c.attr("readonly")),
            l.isDisabled && c.attr("disabled", !0),
            (l.isClickable =
              l.browseOnZoneClick &&
              l.showPreview &&
            ...
            (l.slug =
              "function" == typeof n.slugCallback
                ? n.slugCallback
                : l._slugDefault),
            ...
            t.isEmpty(c.attr("id")) && c.attr("id", t.uniqId()),
            (l.namespace = ".fileinput_" + c.attr("id").replace(/-/g, "_")),
            void 0 === l.$container
              ? (l.$container = l._createContainer())
              : l._refreshContainer(),
            (o = l.$container),
            (l.$dropZone = o.find(".file-drop-zone")),
            (l.$progress = o.find(".kv-upload-progress")),
            (l.$btnUpload = o.find(".fileinput-upload")),
            ...
            (l.$caption = t.getElement(
              n,
              "elCaptionText",
              o.find(".file-caption-name")
            )),
            t.isEmpty(l.msgPlaceholder) ||
              ((r = c.attr("multiple") ? l.filePlural : l.fileSingle),
              l.$caption.attr(
                "placeholder",
            ...
            (l.$preview = t.getElement(
              n,
              "elPreviewImage",
              o.find(".file-preview-thumbnails")
            )),
            (l.$previewStatus = t.getElement(
              n,
              "elPreviewStatus",
              o.find(".file-preview-status")
            )),
        ...
        _initTemplateDefaults: function () {
          ...
          (n =
            ...
            (o = '<i class="glyphicon glyphicon-file"></i>'),
            (s =
            ...
            U._isPdfRendered() &&
              (z = U.pdfRendererTemplate.replace(
                "{renderer}",
                U._encodeURI(U.pdfRendererUrl)
              )),
            (U.defaults = {
              layoutTemplates: {
                main1: n,
              ...
              fileTypeSettings: {
                image: function (e, n) {
                  return (
                    ...
                    t.compare(n, /\.(gif|png|jpe?g)$/i)
                  );
                },
                html: function (e, n) {
                  return (
                    t.compare(e, "text/html") || t.compare(n, /\.(htm|html)$/i)
                  );
                },
                office: function (e, n) {
                  return (
                    t.compare(e, /(word|excel|powerpoint|office)$/i) ||
                    t.compare(n, /\.(docx?|xlsx?|pptx?|pps|potx?)$/i)
                  );
                },
                gdocs: function (e, n) {
                  return (
                ...
                text: function (e, n) {
                  return (
                    t.compare(e, "text.*") ||
                    t.compare(n, /\.(xml|javascript)$/i) ||
                    t.compare(n, /\.(txt|md|csv|nfo|ini|json|php|js|css)$/i)
                  );
                },
                video: function (e, n) {
                  return (
                    ...
                    (t.compare(e, /(ogg|mp4|mp?g|mov|webm|3gp)$/i) ||
                      t.compare(n, /\.(og?|mp4|webm|mp?g|mov|3gp)$/i))
                  );
                },
                audio: function (e, n) {
                  return (
                    t.compare(e, "audio.*") &&
                    (t.compare(n, /(ogg|mp3|mp?g|wav)$/i) ||
                      t.compare(n, /\.(og?|mp3|mp?g|wav)$/i))
                  );
                },
                flash: function (e, n) {
                  return (
            ...
            e.each(U.defaults, function (t, n) {
              return "allowedPreviewTypes" === t
                ? void (
                    void 0 === U.allowedPreviewTypes &&
                    (U.allowedPreviewTypes = n)
                  )
                : void (U[t] = e.extend(!0, {}, n, U[t]));
            }),
        ...
        _initPreviewTemplates: function () {
          var n,
            i = this,
            r = i.previewMarkupTags,
            o = r.tagAfter;
          e.each(i.previewContentTemplates, function (e, a) {
            t.isEmpty(i.previewTemplates[e]) &&
              ((n = r.tagBefore2),
              ("generic" !== e &&
                "image" !== e &&
                "html" !== e &&
        ...
        _initPreviewCache: function () {
          ...
          (n.previewCache = {
            ...
            init: function () {
              ...
              e.length > 0 &&
                !t.isArray(e) &&
                (e = e.split(n.initialPreviewDelimiter)),
                (n.previewCache.data = {
                  content: e,
            ...
            count: function () {
              return n.previewCache.data && n.previewCache.data.content
                ? n.previewCache.data.content.length
                : 0;
            },
            get: function (i, r) {
              var o,
                ...
                d,
                p = "init_" + i,
                f = n.previewCache.data,
                h = f.config[i],
                m = f.content[i],
                g = n.previewInitId + "-" + p,
                v = t.ifSet("previewAsData", h, n.initialPreviewAsData),
                y = h
                  ? { title: h.title || null, alt: h.alt || null }
                  : { title: null, alt: null },
              ...
              return m
                ? ((r = void 0 === r || r),
                  (s = t.ifSet(
                    "type",
                    h,
                    n.initialPreviewFileType || "generic"
                  )),
                  (c = t.ifSet("filename", h, t.ifSet("caption", h))),
                  (u = t.ifSet("filetype", h, s)),
                  (l = n.previewCache.footer(i, r, (h && h.size) || null)),
                  (d = t.ifSet("frameClass", h)),
                  (o = v
                    ? w(s, m, c, u, g, l, p, d)
                    : w("generic", m, c, u, g, l, p, d, s).setTokens({
                        content: f.content[i],
                      })),
                  f.tags.length &&
                    f.tags[i] &&
                    (o = t.replaceTags(o, f.tags[i])),
                  t.isEmpty(h) ||
                    t.isEmpty(h.frameAttr) ||
                    ((a = e(document.createElement("div")).html(o)),
                    a.find(".file-preview-initial").attr(h.frameAttr),
                    (o = a.html()),
                    a.remove()),
                  o)
                : "";
            ...
            add: function (e, i, r, o) {
              var a,
                s = n.previewCache.data;
              return (
                t.isArray(e) || (e = e.split(n.initialPreviewDelimiter)),
                o
                  ? ((a = s.content.push(e) - 1),
                    (s.config[a] = i),
                    (s.tags[a] = r))
                  : ((a = e.length - 1),
                    (s.content = e),
            ...
            unset: function (e) {
              var i = n.previewCache.count(),
                r = n.reversePreviewOrder;
              if (i) {
                if (1 === i)
                  return (
                    (n.previewCache.data.content = []),
                    (n.previewCache.data.config = []),
                    (n.previewCache.data.tags = []),
                    (n.initialPreview = []),
                    (n.initialPreviewConfig = []),
                    void (n.initialPreviewThumbTags = [])
                  );
                (n.previewCache.data.content = t.spliceArray(
                  n.previewCache.data.content,
                  e,
                  r
                )),
                  (n.previewCache.data.config = t.spliceArray(
                    n.previewCache.data.config,
                    e,
                    r
                  )),
                  (n.previewCache.data.tags = t.spliceArray(
                    n.previewCache.data.tags,
                    e,
                    r
                  ));
            ...
            out: function () {
              var e,
                ...
                i,
                r = "",
                o = n.previewCache.count();
              if (0 === o) return { content: "", caption: "" };
              for (t = 0; o > t; t++)
                (i = n.previewCache.get(t)),
                  (r = n.reversePreviewOrder ? i + r : r + i);
            ...
            footer: function (e, i, r) {
              ...
              (t.isEmpty(o.config) || t.isEmpty(o.config[e])) &&
                (o.config[e] = {}),
                (i = void 0 === i || i);
              var a,
                s = o.config[e],
                l = t.ifSet("caption", s),
                c = t.ifSet("width", s, "auto"),
                u = t.ifSet("url", s, !1),
                d = t.ifSet("key", s, null),
                p = n.fileActionSettings,
                f = n.initialPreviewShowDelete || !1,
                h = s.downloadUrl || n.initialPreviewDownloadUrl || "",
                m = s.filename || s.caption || "",
                g = !!h,
                ...
                b = t.ifSet("showDrag", s, t.ifSet("showDrag", p, !0)),
                C = !1 === u && i;
              return (
                (y = y && !1 !== s.downloadUrl && !!h),
                (a = n._renderFileActions(!1, y, v, w, b, C, u, d, !0, h, m)),
                n
        ...
        _errorsExist: function () {
          var t,
            n = this;
          return (
            !!n.$errorContainer.find("li").length ||
            ((t = e(document.createElement("div")).html(
              n.$errorContainer.html()
            )),
        ...
        _errorHandler: function (e, t) {
          ...
          !(function (e) {
            ...
            i.code === i.NOT_FOUND_ERR
              ? n.msgFileNotFound
              : i.code === i.SECURITY_ERR
              ? n.msgFileSecured
              : i.code === i.NOT_READABLE_ERR
              ? n.msgFileNotReadable
              : i.code === i.ABORT_ERR
              ? n.msgFilePreviewAborted
              : n.msgFilePreviewError
          );
        },
        _addError: function (e) {
          ...
          e &&
            n.length &&
            (n.html(t.errorCloseButton + e),
            t._handler(n.find(".kv-error-close"), "click", function () {
              setTimeout(function () {
        ...
        _setValidationError: function (e) {
          var n = this;
          (e = (e ? e + " " : "") + "has-error"),
            n.$container.removeClass(e).addClass("has-error"),
            t.addCss(n.$captionContainer, "is-invalid");
        },
        ...
        _showFolderError: function (e) {
          var t,
            ...
            i = n.$errorContainer;
          e &&
            (n.isAjaxUpload || n._clearFileInput(),
            (t = n.msgFoldersNotAllowed.replace("{n}", e)),
            n._addError(t),
            n._setValidationError(),
            i.fadeIn(800),
            n._raise("filefoldererror", [e, t]));
        },
        _showUploadError: function (e, t, n) {
          ...
          return (
            ...
            r.fadeIn(800),
            i._raise(o, [t, e]),
            i._setValidationError("file-input-new"),
            !0
          );
        },
        ...
        _parseError: function (t, n, i, r) {
          var o,
            ...
            s = e.trim(i + ""),
            l =
              void 0 !== n.responseJSON && void 0 !== n.responseJSON.error
                ? n.responseJSON.error
                : n.responseText;
          return (
            a.cancelling && a.msgUploadAborted && (s = a.msgUploadAborted),
            a.showAjaxErrorDetails &&
              l &&
              ((l = e.trim(l.replace(/\n\s*\n/g, "\n"))),
              (o = l.length ? "<pre>" + l + "</pre>" : ""),
              (s += s ? o : l)),
            s || (s = a.msgAjaxError.replace("{operation}", t)),
            (a.cancelling = !1),
            r ? "<b>" + r + ": </b>" + s : s
          );
        },
        ...
        _getPreviewIcon: function (t) {
          ...
          return (
            t &&
              t.indexOf(".") > -1 &&
              ((n = t.split(".").pop()),
              i.previewFileIconSettings &&
                (r =
                  i.previewFileIconSettings[n] ||
                  i.previewFileIconSettings[n.toLowerCase()] ||
                  null),
              i.previewFileExtSettings &&
                e.each(i.previewFileExtSettings, function (e, t) {
                  return i.previewFileIconSettings[e] && t(n)
                    ? void (r = i.previewFileIconSettings[e])
                    : void 0;
                })),
            r
          );
        ...
        _parseFilePreviewIcon: function (e, t) {
          var n = this,
            i = n._getPreviewIcon(t) || n.previewFileIcon,
            r = e;
          return (
        ...
        _raise: function (t, n) {
          var i = this,
            r = e.Event(t);
          if (
            (void 0 !== n ? i.$element.trigger(r, n) : i.$element.trigger(r),
            r.isDefaultPrevented() || !1 === r.result)
          )
            return !1;
          switch (t) {
        ...
        _listen: function () {
          ...
          i._handler(r, "click", function (e) {
            ...
            i._handler(r, "change", e.proxy(i._change, i)),
            i.showBrowse &&
              i._handler(i.$btnFile, "click", e.proxy(i._browse, i)),
            i._handler(
              a.find(".fileinput-remove:not([disabled])"),
              "click",
              e.proxy(i.clear, i)
            ),
            i._handler(
              a.find(".fileinput-cancel"),
              "click",
              e.proxy(i.cancel, i)
            ),
            i._initDragDrop(),
            i._handler(o, "reset", e.proxy(i.clear, i)),
            i.isAjaxUpload ||
              i._handler(o, "submit", e.proxy(i._submitForm, i)),
            i._handler(
            ...
            i._handler(e(document), n, function () {
        ...
        _autoFitContent: function () {
          var t,
            ...
            r =
              400 > n
                ? i.previewSettingsSmall || i.defaults.previewSettingsSmall
                : i.previewSettings || i.defaults.previewSettings;
                ...
                r.readEntries(function (r) {
                  if (r && r.length > 0) {
                    for (i = 0; i < r.length; i++)
                      a._scanDroppedItems(r[i], t, n + e.name + "/");
                    o();
                  }
                  return null;
                }, s);
        ...
        _initDragDrop: function () {
          ...
          t.dropZoneEnabled &&
            t.showPreview &&
            (t._handler(n, "dragenter dragover", e.proxy(t._zoneDragEnter, t)),
            t._handler(n, "dragleave", e.proxy(t._zoneDragLeave, t)),
            t._handler(n, "drop", e.proxy(t._zoneDrop, t)),
            t._handler(
              e(document),
        ...
        _zoneDragEnter: function (n) {
          var i = this,
            r = n.originalEvent.dataTransfer,
            o = e.inArray("Files", r.types) > -1;
          return (
            i._zoneDragDropInit(n),
            i.isDisabled || !o
              ? ((n.originalEvent.dataTransfer.effectAllowed = "none"),
                void (n.originalEvent.dataTransfer.dropEffect = "none"))
              : void (
                  i._raise("fileDragEnter", {
                    sourceEvent: n,
                    files: r.types.Files,
        ...
        _zoneDrop: function (e) {
          var n,
            i = this,
            r = i.$element,
            o = e.originalEvent.dataTransfer,
            a = o.files,
            s = o.items,
            l = t.getDragDropFolders(s),
            c = function () {
              i.isAjaxUpload
                ? i._change(e, a)
                : ((i.changeTriggered = !0),
          ...
          if (
            ...
            !i.isDisabled &&
              !t.isEmpty(a) &&
              i._raise("fileDragDrop", { sourceEvent: e, files: a }))
          )
            if (l > 0) {
        ...
        _uploadClick: function (e) {
          var n,
            i = this,
            r = i.$container.find(".fileinput-upload"),
        ...
        _clearPreview: function () {
          var n = this,
            i = n.$preview;
          (n.showUploadedThumbs
            ? n.getFrames(":not(.file-preview-success)")
            : n.getFrames()
          ).each(function () {
            var n = e(this);
            n.remove(), t.cleanZoomCache(i.find("#zoom-" + n.attr("id")));
          }),
            (n.getFrames().length && n.showPreview) || n._resetUpload(),
            n._validateDefaultPreview();
        },
        _initSortable: function () {
          ...
          window.KvSortable &&
            ...
            ((n = {
              ...
              onSort: function (n) {
                var r = n.oldIndex,
                  o = n.newIndex,
                  s = 0;
                (i.initialPreview = t.moveArray(i.initialPreview, r, o, a)),
                  (i.initialPreviewConfig = t.moveArray(
                  ...
                  i.previewCache.init(),
                  i.getFrames(".file-preview-initial").each(function () {
            ...
            e.extend(!0, n, i.fileActionSettings.dragSettings),
            r.kvsortable(n));
        },
        ...
        _initPreview: function (e) {
          var n,
            i = this,
            r = i.initialCaption || "";
          return i.previewCache.count()
            ? ((n = i.previewCache.out()),
              (r = e && i.initialCaption ? i.initialCaption : n.caption),
              i._setPreviewContent(n.content),
              i._setInitThumbAttr(),
              i._setCaption(r),
              i._initSortable(),
              void (
            ...
            : (i._clearPreview(),
              void (e ? i._setCaption(r) : i._initCaption()));
        },
        ...
        _listenModalEvent: function (e) {
          ...
          i.on(e + ".bs.modal", function (o) {
            var a = i.find(".btn-fullscreen"),
              s = i.find(".btn-borderless");
            n._raise("filezoom" + e, r(o)),
              "shown" === e &&
                (s.removeClass("active").attr("aria-pressed", "false"),
                a.removeClass("active").attr("aria-pressed", "false"),
                i.hasClass("file-zoom-fullscreen") &&
                  (n._maximizeZoomDialog(),
                  t.checkFullScreen()
                    ? a.addClass("active").attr("aria-pressed", "true")
        ...
        _initZoom: function () {
          var n,
            i = this,
            r = i._getLayoutTemplate("modalMain"),
            o = "#" + t.MODAL_ID;
          i.showPreview &&
            ((i.$modal = e(o)),
            (i.$modal && i.$modal.length) ||
              ((n = e(document.createElement("div"))
                .html(r)
                .insertAfter(i.$container)),
              (i.$modal = e(o).insertBefore(n)),
              n.remove()),
            t.initModal(i.$modal),
            i.$modal.html(i._getModalContent()),
        ...
        _initZoomButtons: function () {
          var t,
            n,
            i = this,
            r = i.$modal.data("previewId") || "",
            o = i.getFrames().toArray(),
            a = o.length,
        ...
        _maximizeZoomDialog: function () {
          var t = this,
            ...
            r = n.find(".modal-footer:visible"),
            o = n.find(".modal-body"),
            a = e(window).height(),
            s = 0;
          n.addClass("file-zoom-fullscreen"),
            i && i.length && (a -= i.outerHeight(!0)),
            r && r.length && (a -= r.outerHeight(!0)),
            o && o.length && ((s = o.outerHeight(!0) - o.height()), (a -= s)),
            n.find(".kv-zoom-body").height(a);
        },
        _resizeZoomDialog: function (e) {
          var n = this,
            i = n.$modal,
            r = i.find(".btn-fullscreen"),
        ...
        _setZoomContent: function (n, i) {
          var r,
            ...
            h = this,
            m = n.attr("id"),
            g = h.$preview.find("#zoom-" + m),
            v = h.$modal,
            y = v.find(".btn-fullscreen"),
            w = v.find(".btn-borderless"),
            b = v.find(".btn-toggleheader");
          (o = g.attr("data-template") || "generic"),
            (r = g.find(".kv-file-content")),
            (a = r.length ? r.html() : ""),
            (p = n.data("caption") || ""),
            (f = n.data("size") || ""),
            (s = p + " " + f),
            ...
            i
              ? ((d = l.addClass("file-thumb-loading").clone().insertAfter(l)),
                l.html(a).hide(),
              ...
              : l.html(a),
            (u = h.previewZoomSettings[o]),
            u &&
              ((c = l.find(".kv-preview-data")),
              t.addCss(c, "file-zoom-detail"),
              e.each(u, function (e, t) {
                c.css(e, t),
                  ((c.attr("width") && "width" === e) ||
                    (c.attr("height") && "height" === e)) &&
                    c.removeAttr(e);
              })),
            v.data("previewId", m),
            h._handler(v.find(".btn-prev"), "click", function () {
            ...
            h._handler(b, "click", function () {
              var e,
                ...
                n = v.find(".modal-body .floating-buttons"),
                i = t.find(".kv-zoom-actions"),
                r = function (e) {
                  var n = h.$modal.find(".kv-zoom-body"),
                    i = h.zoomModalHeight;
                  v.hasClass("file-zoom-fullscreen") &&
                    ((i = n.outerHeight(!0)), e || (i -= t.outerHeight(!0))),
                    n.css("height", e ? i + e : i);
                };
              t.is(":visible")
                ? ((e = t.outerHeight(!0)),
            ...
            h._handler(v, "keydown", function (t) {
              var n = t.which || t.keyCode,
                i = e(this).find(".btn-prev"),
                r = e(this).find(".btn-next"),
                o = e(this).data("previewId"),
                a = h.rtl ? 39 : 37,
                s = h.rtl ? 37 : 39;
              n === a &&
                i.length &&
                !i.attr("disabled") &&
                h._zoomSlideShow("prev", o),
                n === s &&
                  r.length &&
                  !r.attr("disabled") &&
                  h._zoomSlideShow("next", o);
            });
        },
        ...
        _zoomSlideShow: function (t, n) {
          ...
          if (!s.attr("disabled")) {
            ...
            0 > o ||
              ...
              !l[o] ||
              ((i = e(l[o])),
              i.length && a._setZoomContent(i, !0),
              a._initZoomButtons(),
              a._raise("filezoom" + t, { previewId: n, modal: a.$modal }));
          }
        },
        ...
        _refreshPreview: function () {
          var e,
            t = this;
          (t._inputFileCount() || t.isAjaxUpload) &&
            t.showPreview &&
            t.isPreviewable &&
            (t.isAjaxUpload
              ? ((e = t.getFileStack()),
                (t.filestack = []),
                e.length ? t._clearFileInput() : (e = t.$element.get(0).files))
              : (e = t.$element.get(0).files),
            e && e.length && (t.readFiles(e), t._setFileDropZoneTitle()));
        },
        ...
        _clearFileInput: function () {
          ...
          r._inputFileCount() &&
            ((t = o.closest("form")),
            (n = e(document.createElement("form"))),
            (i = e(document.createElement("div"))),
            o.before(i),
            t.length ? t.after(n) : i.after(n),
            n.append(o).trigger("reset"),
            i.before(o).remove(),
            n.remove());
        },
        ...
        _resetPreview: function () {
          var e,
            t,
            n = this;
          n.previewCache.count()
            ? ((e = n.previewCache.out()),
              n._setPreviewContent(e.content),
              n._setInitThumbAttr(),
              (t = n.initialCaption ? n.initialCaption : e.caption),
              n._setCaption(t))
        ...
        _resetPreviewThumbs: function (e) {
          var t,
            n = this;
          return e
            ? (n._clearPreview(), void n.clearStack())
            : void (n._hasInitialPreview()
                ? ((t = n.previewCache.out()),
                  n._setPreviewContent(t.content),
                  n._setInitThumbAttr(),
                  n._setCaption(t.caption),
                  n._initPreviewActions())
                : n._clearPreview());
        },
        _getLayoutTemplate: function (e) {
          var n = this,
            i = n.layoutTemplates[e];
          return t.isEmpty(n.customLayoutTags)
            ? i
            : t.replaceTags(i, n.customLayoutTags);
        },
        _getPreviewTemplate: function (e) {
          var n = this,
            i = n.previewTemplates[e];
          return t.isEmpty(n.customPreviewTags)
            ? i
            : t.replaceTags(i, n.customPreviewTags);
        },
        ...
        _getMsgSelected: function (e) {
          ...
          return e > 0
            ? t.msgSelected.replace("{n}", e).replace("{files}", n)
        ...
        _getFrame: function (t) {
          ...
          return i.length
            ? i
            : (n._log('Invalid thumb frame with id: "' + t + '".'), null);
        },
        _getThumbs: function (e) {
          return (
            (e = e || ""), this.getFrames(":not(.file-preview-initial)" + e)
          );
        },
        _getExtraData: function (e, t) {
          var n = this,
            i = n.uploadExtraData;
          return (
            "function" == typeof n.uploadExtraData &&
              (i = n.uploadExtraData(e, t)),
            i
          );
        },
            ...
            e.upload &&
              e.upload.addEventListener(
                ...
                function (e) {
                  ...
                  e.lengthComputable && (r = Math.floor((a / o) * 100)),
                    t ? i._setAsyncUploadStatus(t, r, n) : i._setProgress(r);
                },
                !1
              ),
            e
        ...
        _mergeAjaxCallback: function (e, t, n) {
          var i,
            r = this,
            o = r._ajaxSettings,
            a = r.mergeAjaxCallbacks;
          "delete" === n &&
            ((o = r._ajaxDeleteSettings), (a = r.mergeAjaxDeleteCallbacks)),
            (i = o[e]),
            (o[e] =
              a && "function" == typeof i
                ? "before" === a
        ...
        _ajaxSubmit: function (t, n, i, r, o, a) {
          var s,
            l,
            c = this;
          c._raise("filepreajax", [o, a]) &&
            (c._uploadExtra(o, a),
            c._initAjaxSettings(),
            c._mergeAjaxCallback("beforeSend", t),
            c._mergeAjaxCallback("success", n),
            c._mergeAjaxCallback("complete", i),
            c._mergeAjaxCallback("error", r),
            (l = a && c.uploadUrlThumb ? c.uploadUrlThumb : c.uploadUrl),
            (s = e.extend(
              !0,
              {},
              {
        ...
        _initUploadSuccess: function (n, i, r) {
          ...
          h.showPreview &&
            "object" == typeof n &&
            !e.isEmptyObject(n) &&
            void 0 !== n.initialPreview &&
            n.initialPreview.length > 0 &&
            ((h.hasInitData = !0),
            (u = n.initialPreview || []),
            (d = n.initialPreviewConfig || []),
            (p = n.initialPreviewThumbTags || []),
            (o = void 0 === n.append || n.append),
            u.length > 0 &&
              !t.isArray(u) &&
              (u = u.split(h.initialPreviewDelimiter)),
            h._mergeArray("initialPreview", u),
            h._mergeArray("initialPreviewConfig", d),
            h._mergeArray("initialPreviewThumbTags", p),
            void 0 !== i
              ? r
                ? ((f = i.attr("data-fileindex")),
                  (h.uploadCache.content[f] = u[0]),
                  (h.uploadCache.config[f] = d[0] || []),
                  (h.uploadCache.tags[f] = p[0] || []),
                  (h.uploadCache.append = o))
                : ((s = h.previewCache.add(u, d[0], p[0], o)),
                  (a = h.previewCache.get(s, !1)),
                  (l = e(document.createElement("div"))
                    .html(a)
                    .hide()
                    .insertAfter(i)),
                  (c = l.find(".kv-zoom-cache")),
                  c && c.length && c.insertAfter(i),
                  i.fadeOut("slow", function () {
                    ...
                    e &&
                      ...
                      h._clearFileInput(),
                      t.cleanZoomCache(
                        h.$preview.find("#zoom-" + i.attr("id"))
                      ),
                      i.remove(),
                      l.remove(),
                      h._initSortable();
                  }))
              : (h.previewCache.set(u, d, p, o),
                h._initPreview(),
                h._initPreviewActions()));
        },
        _initSuccessThumbs: function () {
          var n = this;
          n.showPreview &&
            n._getThumbs(t.FRAMES + ".file-preview-success").each(function () {
              var i = e(this),
                r = n.$preview,
                o = i.find(".kv-file-remove");
              o.removeAttr("disabled"),
                n._handler(o, "click", function () {
                  var e = i.attr("id"),
                    o = n._raise("filesuccessremove", [
                      e,
                      i.attr("data-fileindex"),
                    ]);
                  t.cleanMemory(i),
                    !1 !== o &&
                      i.fadeOut("slow", function () {
        ...
        _uploadSingle: function (n, i) {
          var r,
            ...
            b = e("#" + y).find(".file-thumb-progress"),
            C = { id: y, index: n };
          (m.formdata = v),
            m.showPreview &&
              ((o = e("#" + y + ":not(.file-preview-initial)")),
              (s = o.find(".kv-file-upload")),
              (l = o.find(".kv-file-remove")),
              b.show()),
            0 === g ||
              !w ||
              (s && s.hasClass("disabled")) ||
              m._abort(C) ||
              ((h = function (e, t) {
                c || m.updateStack(e, void 0),
                  m.uploadLog.push(t),
                  m._checkAsyncComplete() && (m.fileBatchCompleted = !0);
              }),
              (a = function () {
                var e,
                  n,
                  ...
                  r = m.uploadCache,
                  o = 0,
                  a = m.cacheInitialPreview;
                m.fileBatchCompleted &&
                  (a && a.content && (o = a.content.length),
                  setTimeout(function () {
                    ...
                    if (m.showPreview) {
                      if (
                        ...
                        for (n = 0; n < r.content.length; n++)
                          (i = n + o),
                            (a.content[i] = r.content[n]),
                            a.config.length && (a.config[i] = r.config[n]),
                            a.tags.length && (a.tags[i] = r.tags[n]);
                        (m.initialPreview = t.cleanArray(a.content)),
                          (m.initialPreviewConfig = t.cleanArray(a.config)),
                          (m.initialPreviewThumbTags = t.cleanArray(a.tags));
                      } else
                        (m.initialPreview = r.content),
                          (m.initialPreviewConfig = r.config),
                          (m.initialPreviewThumbTags = r.tags);
                      (m.cacheInitialPreview = {}),
                        m.hasInitData &&
                          (m._initPreview(), m._initPreviewActions());
                    }
                    m.unlock(s),
                      s && m._clearFileInput(),
                      (e = m.$preview.find(".file-preview-initial")),
                      m.uploadAsync &&
                        e.length &&
                        (t.addCss(e, t.SORT_CSS), m._initSortable()),
                      m._raise("filebatchuploadcomplete", [
                        m.filestack,
                        m._getExtraData(),
                      ]),
                      (m.uploadCount = 0),
              ...
              (u = function (a) {
                (r = m._getOutData(a)),
                  (m.fileBatchCompleted = !1),
                  i || (m.ajaxAborted = !1),
                  m.showPreview &&
                    (o.hasClass("file-preview-success") ||
                      (m._setThumbStatus(o, "Loading"),
                      t.addCss(o, "file-uploading")),
                    s.attr("disabled", !0),
                    l.attr("disabled", !0)),
                  i || m.lock(),
                  m._raise("filepreupload", [r, y, n]),
                  e.extend(!0, C, r),
                  m._abort(C) &&
                    (a.abort(),
                    i ||
                      (m._setThumbStatus(o, "New"),
                ...
                (r = m._getOutData(u, a)),
                  ...
                  setTimeout(function () {
                    t.isEmpty(a) || t.isEmpty(a.error)
                      ? (m.showPreview &&
                          (m._setThumbStatus(o, "Success"),
                          s.hide(),
                          m._initUploadSuccess(a, o, i),
                          m._setProgress(101, b)),
                        m._raise("fileuploaded", [r, d, n]),
                        i ? h(n, d) : m.updateStack(n, void 0))
                      : ((c = !0),
                        m._showUploadError(a.error, C),
                        m._setPreviewError(
                          o,
                          n,
                          m.filestack[n],
                        ...
                        m.retryErrorUploads || s.hide(),
                        i && h(n, d),
                        m._setProgress(
                          101,
                          e("#" + d).find(".file-thumb-progress"),
                          m.msgUploadError
                        ));
                  }, 100);
              }),
              (p = function () {
                setTimeout(function () {
                  m.showPreview &&
                    ...
                    l.removeAttr("disabled"),
                    o.removeClass("file-uploading")),
                    i ? a() : (m.unlock(!1), m._clearFileInput()),
                    m._initSuccessThumbs();
                }, 100);
              }),
              (f = function (t, r, a) {
                var l = m.ajaxOperations.uploadThumb,
                  u = m._parseError(
                    ...
                    t,
                    a,
                    i && m.filestack[n].name ? m.filestack[n].name : null
                  );
                (c = !0),
                  setTimeout(function () {
                    i && h(n, y),
                      (m.uploadStatus[y] = 100),
                      m._setPreviewError(
                        o,
                        n,
                        m.filestack[n],
                      ...
                      m.retryErrorUploads || s.hide(),
                      e.extend(!0, C, m._getOutData(t)),
                      m._setProgress(
                        101,
                        b,
                        m.msgAjaxProgressError.replace("{operation}", l)
                      ),
                      m._setProgress(
                        101,
                        e("#" + y).find(".file-thumb-progress"),
                        m.msgUploadError
                      ),
                      m._showUploadError(u, C);
                  }, 100);
              }),
              v.append(m.uploadFileAttr, m.filestack[n], m.filenames[n]),
              v.append("file_id", n),
              m._ajaxSubmit(u, d, p, f, y, n));
        },
        _uploadBatch: function () {
          ...
          (s.formdata = new FormData()),
            0 !== c &&
                ...
                (s.ajaxAborted = !1),
                  s.showPreview &&
                    s._getThumbs().each(function () {
                      var n = e(this),
                        i = n.find(".kv-file-upload"),
                        r = n.find(".kv-file-remove");
                      n.hasClass("file-preview-success") ||
                        (s._setThumbStatus(n, "Loading"),
                        t.addCss(n, "file-uploading")),
                        i.attr("disabled", !0),
                        r.attr("disabled", !0);
                    }),
                  s._raise("filebatchpreupload", [i]),
                  s._abort(i) &&
                    (n.abort(),
                    s._getThumbs().each(function () {
                      var t = e(this),
              ...
              (i = function (n, i, r) {
                ...
                t.isEmpty(n) || t.isEmpty(n.error)
                  ...
                  : (s.showPreview &&
                      ...
                      s._initUploadSuccess(n)),
                    s._showUploadError(n.error, o, "filebatchuploaderror"),
              ...
              (r = function (t, n, i) {
                var r = s._getOutData(t),
                  o = s.ajaxOperations.uploadBatch,
                  a = s._parseError(o, t, i);
                s._showUploadError(a, r, "filebatchuploaderror"),
                  ...
                  s.showPreview &&
                    (s._getThumbs().each(function () {
                      var t = e(this),
                        n = t.attr("data-fileindex");
                      t.removeClass("file-uploading"),
                        void 0 !== s.filestack[n] && s._setPreviewError(t);
                    }),
                    ...
                    s._setProgress(
                      101,
                      s.$progress,
                      s.msgAjaxProgressError.replace("{operation}", o)
                    ));
              }),
              e.each(l, function (e, n) {
                t.isEmpty(l[e]) ||
                  s.formdata.append(s.uploadFileAttr, n, s.filenames[e]);
              }),
            ...
            o._abort(a) ||
              ((e = function (e) {
                ...
                o._raise("filebatchpreupload", [t]),
                  ...
                  (a.data = t),
                  (a.xhr = e),
                  o._abort(a) && (e.abort(), o._setProgressCancelled());
              }),
              (n = function (e, n, i) {
                ...
                t.isEmpty(e) || t.isEmpty(e.error)
                  ? (o._raise("filebatchuploadsuccess", [r]),
                    ...
                    o._setProgress(101))
                  : o._showUploadError(e.error, r, "filebatchuploaderror");
              }),
              (i = function () {
                o.unlock(),
                  o._clearFileInput(),
              ...
              (r = function (e, t, n) {
                var i = o._getOutData(e),
                  ...
                  s = o._parseError(r, e, n);
                (a.data = i),
                  o._showUploadError(s, i, "filebatchuploaderror"),
                  o._setProgress(
                    101,
                    o.$progress,
                    o.msgAjaxProgressError.replace("{operation}", r)
                  );
              }),
        ...
        _deleteFileIndex: function (n) {
          var i = this,
            ...
            o = i.reversePreviewOrder;
          "init_" === r.substring(0, 5) &&
            ((r = parseInt(r.replace("init_", ""))),
            (i.initialPreview = t.spliceArray(i.initialPreview, r, o)),
            (i.initialPreviewConfig = t.spliceArray(
              i.initialPreviewConfig,
              r,
              o
            )),
            (i.initialPreviewThumbTags = t.spliceArray(
              i.initialPreviewThumbTags,
              r,
              o
            )),
            i.getFrames().each(function () {
              var t = e(this),
                n = t.attr("data-fileindex");
              "init_" === n.substring(0, 5) &&
                (n = parseInt(n.replace("init_", ""))) > r &&
                (n--, t.attr("data-fileindex", "init_" + n));
            }),
        ...
        _initFileActions: function () {
          ...
          n.showPreview &&
            (n._initZoomButton(),
            n.getFrames(" .kv-file-remove").each(function () {
              var r,
                o,
                a,
                s,
                l = e(this),
                c = l.closest(t.FRAMES),
                u = c.attr("id"),
                d = c.attr("data-fileindex");
              n._handler(l, "click", function () {
                return (
                  !(
                    !1 === (s = n._raise("filepreremove", [u, d])) ||
                    !n._validateMinCount()
                  ) &&
                  ((r = c.hasClass("file-preview-error")),
                  t.cleanMemory(c),
                  void c.fadeOut("slow", function () {
                    t.cleanZoomCache(i.find("#zoom-" + u)),
                      n.updateStack(d, void 0),
                      n._clearObjects(c),
                      c.remove(),
                      u &&
                        r &&
                        n.$errorContainer
                          .find('li[data-thumb-id="' + u + '"]')
                          .fadeOut("fast", function () {
                            e(this).remove(),
                              n._errorsExist() || n._resetErrors();
                          }),
                      n._clearFileInput();
                    var s = n.getFileStack(!0),
            ...
            n.getFrames(" .kv-file-upload").each(function () {
              ...
              n._handler(i, "click", function () {
                var e = i.closest(t.FRAMES),
                  r = e.attr("data-fileindex");
                n.$progress.hide(),
                  (e.hasClass("file-preview-error") && !n.retryErrorUploads) ||
                    n._uploadSingle(r, !1);
              });
            }));
        },
        _initPreviewActions: function () {
          var n = this,
            i = n.$preview,
            r = n.deleteExtraData || {},
            o = t.FRAMES + " .kv-file-remove",
            a = n.fileActionSettings,
            s = a.removeClass,
            l = a.removeErrorClass,
            c = function () {
              var e = n.isAjaxUpload
                ? n.previewCache.count()
                : n._inputFileCount();
              i.find(t.FRAMES).length ||
                e ||
                (n._setCaption(""), n.reset(), (n.initialCaption = ""));
            };
          n._initZoomButton(),
            i.find(o).each(function () {
              var o,
                a,
                u,
                d = e(this),
                p = d.data("url") || n.deleteUrl,
                f = d.data("key");
              if (!t.isEmpty(p) && void 0 !== f) {
                var h,
                  ...
                  g,
                  v,
                  y = d.closest(t.FRAMES),
                  w = n.previewCache.data,
                  b = y.attr("data-fileindex");
                (b = parseInt(b.replace("init_", ""))),
                  (g =
                    t.isEmpty(w.config) && t.isEmpty(w.config[b])
                      ? null
                      : w.config[b]),
                  (v = t.isEmpty(g) || t.isEmpty(g.extra) ? r : g.extra),
                  "function" == typeof v && (v = v()),
                  (m = { id: d.attr("id"), key: f, extra: v }),
                  (o = function (e) {
                    (n.ajaxAborted = !1),
                      n._raise("filepredelete", [f, e, v]),
                      n._abort()
                        ? e.abort()
                        : (d.removeClass(l),
                          t.addCss(y, "file-uploading"),
                          t.addCss(d, "disabled " + s));
                  }),
                  (a = function (e, r, o) {
                    var a, u;
                    return t.isEmpty(e) || t.isEmpty(e.error)
                      ? (y
                        ...
                        void y.fadeOut("slow", function () {
                          (b = parseInt(
                            y.attr("data-fileindex").replace("init_", "")
                          )),
                            n.previewCache.unset(b),
                            n._deleteFileIndex(y),
                            (a = n.previewCache.count()),
                            (u = a > 0 ? n._getMsgSelected(a) : ""),
                            n._setCaption(u),
                            n._raise("filedeleted", [f, o, v]),
                            t.cleanZoomCache(i.find("#zoom-" + y.attr("id"))),
                            n._clearObjects(y),
                            y.remove(),
                            c();
                        }))
                      : ((m.jqXHR = o),
                        (m.response = e),
                        n._showError(e.error, m, "filedeleteerror"),
                        y.removeClass("file-uploading"),
                        d.removeClass("disabled " + s).addClass(l),
                        void c());
                  }),
                  (u = function (e, t, i) {
                    var r = n.ajaxOperations.deleteThumb,
                      o = n._parseError(r, e, i);
                    (m.jqXHR = e),
                      (m.response = {}),
                      n._showError(o, m, "filedeleteerror"),
                      y.removeClass("file-uploading"),
                      d.removeClass("disabled " + s).addClass(l),
                      c();
                  }),
                  n._initAjaxSettings(),
                  n._mergeAjaxCallback("beforeSend", o, "delete"),
                  n._mergeAjaxCallback("success", a, "delete"),
                  n._mergeAjaxCallback("error", u, "delete"),
                  (h = e.extend(
                    !0,
                    {},
                    {
                    ...
                    n._ajaxDeleteSettings
                  )),
                  n._handler(d, "click", function () {
                    return (
                      !!n._validateMinCount() &&
                      ((n.ajaxAborted = !1),
                      n._raise("filebeforedelete", [f, v]),
                      void (n.ajaxAborted instanceof Promise
                        ? n.ajaxAborted.then(function (t) {
                            t || e.ajax(h);
                          })
        ...
        _getSize: function (t) {
          var n,
            ...
            a = parseFloat(t),
            s = o.fileSizeGetter;
          return e.isNumeric(t) && e.isNumeric(a)
            ? ("function" == typeof s
                ? (r = s(a))
                : 0 === a
                ? (r = "0.00 B")
                : ((n = Math.floor(Math.log(a) / Math.log(1024))),
                  ...
                  (r = 1 * (a / Math.pow(1024, n)).toFixed(2) + " " + i[n])),
              o._getLayoutTemplate("size").replace("{sizeText}", r))
            : "";
        },
        ...
        _generatePreviewTemplate: function (
          ...
          var h,
            ...
            b =
              400 > w
                ? m.previewSettingsSmall[n] ||
                  m.defaults.previewSettingsSmall[n]
                : m.previewSettings[n] || m.defaults.previewSettings[n],
            C = g,
            x = g,
            _ = u || m._renderFileFooter(g, l, "auto", s),
            T = m._getPreviewIcon(r),
            S = "type-default",
            E = T && m.preferIconicPreview,
            k = T && m.preferIconicZoomPreview;
          return (
            b &&
            ...
            (h = function (i, s, l, u) {
              var h = l ? "zoom-" + a : a,
                v = m._getPreviewTemplate(i),
                w = (c || "") + " " + u;
              return (
                m.frameClass && (w = m.frameClass + " " + w),
                l && (w = w.replace(" " + t.SORT_CSS, "")),
                (v = m._parseFilePreviewIcon(v, r)),
                "text" === i && (s = t.htmlEncode(s)),
                "object" !== n ||
                  o ||
                  e.each(m.defaults.fileTypeSettings, function (e, t) {
                    "object" !== e &&
                      "other" !== e &&
                      t(r, o) &&
                      (S = "type-" + e);
                ...
                t.isEmpty(f) ||
                  (void 0 !== f.title && null !== f.title && (C = f.title),
                  void 0 !== f.alt && null !== f.alt && (C = f.alt)),
                v.setTokens({
                  previewId: h,
                  caption: g,
                  title: C,
            ...
            (d = d || a.slice(a.lastIndexOf("-") + 1)),
            m.fileActionSettings.showZoom &&
              (v = h(k ? "other" : n, i, !0, "kv-zoom-thumb")),
            (v =
              "\n" +
              m._getLayoutTemplate("zoomCache").replace("{zoomContent}", v)),
            h(E ? "other" : n, i, !1, "kv-preview-thumb") + v
          );
        },
        ...
        _previewDefault: function (n, i, r) {
          ...
          if (o.showPreview) {
            var s,
              ...
              u = n.size || 0,
              d = o.slug(l),
              p = !0 === r && !o.isAjaxUpload,
              f = t.createObjectURL(n);
            o._clearDefaultPreview(),
              (s = o._generatePreviewTemplate("other", f, l, c, i, p, u)),
              o._addToPreview(a, s),
              o._setThumbAttr(i, d, u),
              !0 === r &&
                o.isAjaxUpload &&
                o._setThumbStatus(e("#" + i), "Error");
          }
        },
        _previewFile: function (e, n, i, r, o, a) {
          if (this.showPreview) {
            var s,
              ...
              u = a.type,
              d = a.name,
              p = l._parseFileType(u, c),
              f = l.allowedPreviewTypes,
              h = l.allowedPreviewMimeTypes,
              m = l.$preview,
              g = n.size || 0,
              v = f && f.indexOf(p) >= 0,
              y = h && -1 !== h.indexOf(u),
              w =
                "text" === p || "html" === p || "image" === p
                  ? i.target.result
                  : o;
            if (
              ("html" === p &&
                l.purifyHtml &&
                window.DOMPurify &&
                (w = window.DOMPurify.sanitize(w)),
              v || y)
            ) {
              (s = l._generatePreviewTemplate(p, w, c, u, r, !1, g)),
        ...
        _setInitThumbAttr: function () {
          var e,
            ...
            r,
            o = this,
            a = o.previewCache.data,
            s = o.previewCache.count();
          if (0 !== s)
            for (var l = 0; s > l; l++)
              (e = a.config[l]),
                (r = o.previewInitId + "-init_" + l),
                (n = t.ifSet("caption", e, t.ifSet("filename", e))),
                (i = t.ifSet("size", e)),
                o._setThumbAttr(r, n, i);
        },
        ...
        _updateFileDetails: function (e) {
          var n = this,
            ...
            r = n.getFileStack(),
            o =
              (t.isIE(9) && t.findFileName(i.val())) ||
              (i[0].files[0] && i[0].files[0].name) ||
              (r.length && r[0].name) ||
              "",
            a = n.slug(o),
            s = n.isAjaxUpload ? r.length : e,
            l = n.previewCache.count() + s,
            c = 1 === s ? a : n._getMsgSelected(l);
          n.isError
            ? (n.$previewContainer.removeClass("file-thumb-loading"),
              n.$previewStatus.html(""),
              n.$captionContainer.removeClass("icon-visible"))
            : n._showFileIcon(),
            n._setCaption(c, n.isError),
            n.$container.removeClass("file-input-new file-input-ajax-new"),
            1 === arguments.length && n._raise("fileselect", [e, a]),
            n.previewCache.count() && n._initPreviewActions();
        },
        ...
        _setProgress: function (e, n, i) {
          ...
          (n = n || o.$progress),
            t.isEmpty(c) ||
              ((r =
                s && a > s && 100 >= e
                  ? c.setTokens({ percent: s, status: o.msgUploadThreshold })
                  : c.setTokens({
                      percent: a,
                      status: e > 100 ? o.msgUploadEnd : a + "%",
                    })),
              n.html(r),
              i && n.find('[role="progressbar"]').html(i));
        },
        _setFileDropZoneTitle: function () {
          var e,
            n = this,
            i = n.$container.find(".file-drop-zone"),
            r = n.dropZoneTitle;
          n.isClickable &&
            ((e = t.isEmpty(n.$element.attr("multiple"))
              ? n.fileSingle
              : n.filePlural),
            (r += n.dropZoneClickTitle.replace("{files}", e))),
            i.find("." + n.dropZoneTitleClass).remove(),
            !n.showPreview ||
              0 === i.length ||
              n.getFileStack().length > 0 ||
              !n.dropZoneEnabled ||
              (!n.isAjaxUpload && n.$element.files) ||
              (0 === i.find(t.FRAMES).length &&
                t.isEmpty(n.defaultPreviewContent) &&
                i.prepend(
                  '<div class="' + n.dropZoneTitleClass + '">' + r + "</div>"
                ),
              n.$container.removeClass("file-input-new"),
              t.addCss(n.$container, "file-input-ajax-new"));
        },
        _setAsyncUploadStatus: function (t, n, i) {
          var r = this,
            o = 0;
          r._setProgress(n, e("#" + t).find(".file-thumb-progress")),
            (r.uploadStatus[t] = n),
        ...
        _getFileId: function (e) {
          ...
          return "function" == typeof r
            ...
            ? ((n = String(
              ...
              n ? e.size + "-" + n.replace(/[^0-9a-zA-Z_-]/gim, "") : null)
            : null;
        },
        ...
        _refreshUploadButton: function (e, t) {
          var n = this,
            ...
            a = r.uploadTitle;
          i.length &&
            (t && ((o = r.uploadRetryIcon), (a = r.uploadRetryTitle)),
            i.attr("title", a).html(o));
        },
        _checkDimensions: function (e, n, i, r, o, a, s) {
          ...
          !t.isEmpty(f) &&
            ...
            (c =
              "Width" === a
                ? u.naturalWidth || u.width
                : u.naturalHeight || u.height),
            ("Small" === n ? c >= f : f >= c) ||
              ((l = d["msgImage" + a + n].setTokens({ name: o, size: f })),
              d._showUploadError(l, s),
              d._setPreviewError(r, e, null)));
        },
        ...
        _validateImageOrientation: function (e, n, i, r, o, a, s) {
          ...
          return (
            ...
            (l = e.length && d ? u._getExifObj(s) : null),
            (c = l ? l["0th"][piexif.ImageIFD.Orientation] : null)
              ? (t.setImageOrientation(
                  e,
                  u.$preview.find("#zoom-" + i + " img"),
                  c
                ),
                u._raise("fileimageoriented", { $img: e, file: n }),
                void u._validateImage(i, r, o, a, s, l))
              : void u._validateImage(i, r, o, a, s, l)
          );
        },
            ...
            h
              .one("load", function () {
                (l = p.width()),
                  ...
                  l > c && h.css("width", "100%"),
                  (s = { ind: f, id: t }),
                  u._checkDimensions(f, "Small", h, p, n, "Width", s),
                  u._checkDimensions(f, "Small", h, p, n, "Height", s),
                  u.resizeImage ||
                    (u._checkDimensions(f, "Large", h, p, n, "Width", s),
                    u._checkDimensions(f, "Large", h, p, n, "Height", s)),
        ...
        _validateAllImages: function () {
          var e,
            ...
            i = this,
            r = { val: 0 },
            o = i.loadedImages.length,
            a = i.resizeIfSizeMoreThan;
          if (
            o === i.totalImagesCount &&
            (i._raise("fileimagesloaded"), i.resizeImage)
          )
            for (e = 0; e < i.loadedImages.length; e++)
              (t = i.loadedImages[e]),
                t.validated ||
                  ((n = t.siz),
                  n && n > 1e3 * a && i._getResizedImage(t, r, o),
                  (i.loadedImages[e].validated = !0));
        },
        _getResizedImage: function (n, i, r) {
          ...
          if (
            ((c = function (e, t, n) {
              p.isAjaxUpload
                ? p._showUploadError(e, t, n)
                : p._showError(e, t, n),
                p._setPreviewError(S, T);
            }),
            (!p.filestack[T] || !w || (v >= h && y >= m)) &&
              (w && p.filestack[T] && p._raise("fileimageresized", [_, T]),
              i.val++,
              i.val === r && p._raise("fileimagesresized"),
              !w))
          )
            return void c(
          ...
          (x = x || p.resizeDefaultImageType),
            ...
            (b.height = m);
          try {
            C.drawImage(f, 0, 0, h, m),
              (l = b.toDataURL(x, p.resizeQuality)),
              E &&
                ((d = window.piexif.dump(E)), (l = window.piexif.insert(d, l))),
              (o = t.dataURI2Blob(l)),
              (p.filestack[T] = o),
              p._raise("fileimageresized", [_, T]),
              i.val++,
              i.val === r && p._raise("fileimagesresized", [void 0, void 0]),
              o instanceof Blob ||
                c(
                  p.msgImageResizeError,
                  { id: _, index: T },
            ...
            i.val++,
              i.val === r && p._raise("fileimagesresized", [void 0, void 0]),
              (u = p.msgImageResizeException.replace("{errors}", e.message)),
              c(u, { id: _, index: T }, "fileimageresizeexception");
          }
        },
        _initBrowse: function (e) {
          var n = this,
            i = n.$element;
          n.showBrowse
            ? (n.$btnFile = e.find(".btn-file").append(i))
        ...
        _initClickable: function () {
          ...
          r.isClickable &&
            ((n = r.$dropZone),
            r.isAjaxUpload ||
              ((i = r.$preview.find(".file-default-preview")),
              i.length && (n = i)),
            t.addCss(n, "clickable"),
            n.attr("tabindex", -1),
            r._handler(n, "click", function (t) {
              var i = e(t.target);
              e(r.elErrorContainer + ":visible").length ||
                (i.parents(".file-preview-thumbnails").length &&
                  !i.parents(".file-default-preview").length) ||
                (r.$element.data("zoneClicked", !0).trigger("click"), n.blur());
            }));
        },
        _initCaption: function () {
          var e = this,
            n = e.initialCaption || "";
          return e.overwriteInitial || t.isEmpty(n)
            ? (e.$caption.val(""), !1)
            : (e._setCaption(n), !0);
        },
        _setCaption: function (n, i) {
          var r,
            ...
            u = c.getFileStack();
          if (c.$caption.length) {
            if ((c.$captionContainer.removeClass("icon-visible"), i))
              ...
              (r = e("<div>" + n + "</div>").text()),
                (o = r),
                (a = c._getLayoutTemplate("fileIcon"));
            }
            c.$captionContainer.addClass("icon-visible"),
              c.$caption.attr("title", r).val(o),
              c.$captionIcon.html(a);
          }
        },
        _createContainer: function () {
          ...
          return (
            ...
            t._initBrowse(i),
            t.theme && i.addClass("theme-" + t.theme),
            i
          );
        },
        ...
        _renderButton: function (e) {
          var n = this,
            i = n._getLayoutTemplate("btnDefault"),
            r = n[e + "Class"],
            o = n[e + "Title"],
            a = n[e + "Icon"],
            s = n[e + "Label"],
            l = n.isDisabled ? " disabled" : "",
            c = "button";
          switch (e) {
            case "remove":
            ...
            case "upload":
              ...
              n.isAjaxUpload && !n.isDisabled
                ? (i = n
                    ._getLayoutTemplate("btnLink")
                    .replace("{href}", n.uploadUrl))
                : (c = "submit");
              break;
            case "browse":
          ...
          return (
            ...
            t.isEmpty(s) ||
              (s =
                ' <span class="' + n.buttonLabelClass + '">' + s + "</span>"),
            i.setTokens({
              type: c,
              css: r,
              title: o,
        ...
        _renderFileFooter: function (e, n, i, r) {
          var o,
            ...
            u = s.showUpload,
            d = s.showZoom,
            p = a._getLayoutTemplate("footer"),
            f = a._getLayoutTemplate("indicator"),
            h = r ? s.indicatorError : s.indicatorNew,
            m = r ? s.indicatorErrorTitle : s.indicatorNewTitle,
        ...
        _renderFileActions: function (e, t, n, i, r, o, a, s, l, c, u) {
          ...
          var d,
            ...
            y = "",
            w = "",
            b = p._getLayoutTemplate("actions"),
          ...
          return (
            ...
            t &&
              ...
              (v = v.setTokens({ filename: u, key: s }))),
            i &&
              (y = p
            ...
            r &&
              l &&
              ((d = "drag-handle-init " + C.dragClass),
              (w = p
        ...
        _change: function (n) {
          ...
          if (!i.changeTriggered) {
            var r,
              ...
              l = i.isAjaxUpload,
              c = [],
              u = s ? arguments[1] : a.get(0).files,
              d = !l && t.isEmpty(a.attr("multiple")) ? 1 : i.maxFileCount,
              p = i.filestack.length,
              f = t.isEmpty(a.attr("multiple")),
              h = f && p > 0,
              m = i._getFileIds(),
              g = function (t, n, r, o) {
                var a = e.extend(!0, {}, i._getOutData({}, {}, u), {
                    id: r,
                    index: o,
                  }),
              ...
              v = function (e, t) {
                ...
                (i.isError = g(n, null, null, null)),
                  i.$captionContainer.removeClass("icon-visible"),
                  i._setCaption("", !0),
                  i.$container.removeClass(
            ...
            if (
              ...
              i.dropZoneEnabled &&
                i.$container
                  .find(".file-drop-zone ." + i.dropZoneTitleClass)
                  .remove(),
              l
                ? e.each(u, function (e, t) {
                ...
                : ((u =
                    n.target && void 0 === n.target.files
                      ? n.target.value
                        ? [{ name: n.target.value.replace(/^.+\\/, "") }]
                        : []
                      : n.target.files || {}),
                  (c = u)),
              t.isEmpty(c) || 0 === c.length)
            )
              return l || i.clear(), void i._raise("fileselectnone");
            if (
              (i._resetErrors(),
              (o = c.length),
              (r = i._getFileCount(l ? i.getFileStack().length + o : o)),
              d > 0 && r > d)
            ) {
              if (!i.autoReplace || o > d)
                return void v(i.autoReplace && o > d ? o : r, d);
              r > d && i._resetPreviewThumbs(l);
            } else
              !l || h
                ? (i._resetPreviewThumbs(!1), h && i.clearStack())
                : !l ||
                  0 !== p ||
                  (i.previewCache.count() && !i.overwriteInitial) ||
                  i._resetPreviewThumbs(!0);
        ...
        _abort: function (t) {
          var n,
            i = this;
          return i.ajaxAborted &&
            "object" == typeof i.ajaxAborted &&
            void 0 !== i.ajaxAborted.message
            ? ((n = e.extend(!0, {}, i._getOutData(), t)),
              (n.abortData = i.ajaxAborted.data || {}),
              (n.abortMessage = i.ajaxAborted.message),
              i._setProgress(101, i.$progress, i.msgCancelled),
              i._showUploadError(i.ajaxAborted.message, n, "filecustomerror"),
              i.cancel(),
              !0)
            : !!i.ajaxAborted;
        },
        ...
        updateStack: function (e, t) {
          ...
          return (
            (n.filestack[e] = t),
            (n.filenames[e] = n._getFileName(t)),
            (n.fileids[e] = (t && n._getFileId(t)) || null),
            n.$element
          );
        },
        ...
        readFiles: function (n) {
          ...
          var i,
            ...
            m = r.filestack.length,
            g = r.allowedFileTypes,
            v = g ? g.length : 0,
            y = r.allowedFileExtensions,
            w = t.isEmpty(y) ? "" : y.join(", "),
            b = r.maxFilePreviewSize && parseFloat(r.maxFilePreviewSize),
            C = a.length && (!b || isNaN(b)),
            x = function (t, o, a, s) {
              var l,
                c = e.extend(!0, {}, r._getOutData({}, {}, n), {
                  id: a,
                  index: s,
                }),
                u = { id: a, index: s, file: o, files: n };
              r._previewDefault(o, a, !0),
                r.isAjaxUpload
                  ? (r.addToStack(void 0),
                    setTimeout(function () {
                      i(s + 1);
                ...
                r.removeFromPreviewOnError && l.remove(),
                (r.isError = r.isAjaxUpload
                  ? r._showUploadError(t, c)
                  : r._showError(t, u)),
          ...
          (r.loadedImages = []),
            ...
            (i = function (_) {
              ...
              if (L) {
                ...
                if (0 === U.length)
                  return (
                    (E = r.msgInvalidFileName.replace(
                      "{name}",
                      t.htmlEncode(t.getFileName(L), "[unknown]")
                    )),
                    void x(E, L, z, _)
                  );
                if (
                  (t.isEmpty(y) ||
                    (q = new RegExp("\\.(" + y.join("|") + ")$", "i")),
                  (T = H.toFixed(2)),
                  r.maxFileSize > 0 && H > r.maxFileSize)
                )
                  return (
                    (E = r.msgSizeTooLarge.setTokens({
                      name: U,
                      size: T,
                ...
                if (null !== r.minFileSize && H <= t.getNum(r.minFileSize))
                  return (
                    (E = r.msgSizeTooSmall.setTokens({
                      name: U,
                      size: T,
                  ...
                  for (S = 0; S < g.length; S += 1)
                    (k = g[S]),
                      ...
                      (Z +=
                        P &&
                        "function" == typeof P &&
                        P(L.type, t.getFileName(L))
                          ? 1
                          : 0);
                  if (0 === Z)
                    return (
                      (E = r.msgInvalidFileType.setTokens({
                        name: U,
                        types: V,
                      })),
                      void x(E, L, z, _)
                ...
                if (
                  ...
                  !t.isEmpty(q) &&
                  ((A = t.compare(U, q)),
                  0 === (Z += t.isEmpty(A) ? 0 : A.length))
                )
                  return (
                    (E = r.msgInvalidFileExtension.setTokens({
                      name: U,
                      extensions: w,
                    })),
                    void x(E, L, z, _)
                ...
                if (!r.showPreview)
                  return (
                    r.isAjaxUpload && r.addToStack(L),
                    setTimeout(function () {
                      i(_ + 1), r._updateFileDetails(f);
                    }, 100),
                    void r._raise("fileloaded", [L, z, _, s])
                  );
                if (!C && H > b)
                  return (
                    r.addToStack(L),
                    l.addClass("file-thumb-loading"),
                    r._previewDefault(L, z),
                    r._initFileActions(),
                    r._updateFileDetails(f),
                    void i(_ + 1)
                  );
                a.length && void 0 !== FileReader
                  ? ((D = M(L.type, U)),
                    (F = B(L.type, U)),
                    (j = R(L.type, U)),
                    c.html(u.replace("{index}", _ + 1).replace("{files}", f)),
                    l.addClass("file-thumb-loading"),
                      ...
                      var i,
                        ...
                        p = function (e) {
                          ...
                          (t.onerror = function (e) {
                            ...
                            (t.onload = function (e) {
                              r._previewFile(_, L, e, z, W, o),
                                r._initFileActions(),
                                Q();
                            }),
                            e
                              ? t.readAsText(L, r.textEncoding)
                              : t.readAsDataURL(L);
                        };
                      if (
                        ((o = { name: U, type: L.type }),
                        ...
                        for (
                          a = new Uint8Array(n.target.result), S = 0;
                          S < a.length;
                          S++
                        )
                          (l = a[S].toString(16)), d.push(l);
                        if (
                          ((i = d.join("").toLowerCase().substring(0, 8)),
                          (u = t.getMimeType(i, "", "")),
                          t.isEmpty(u) &&
                            ((c = t.arrayBuffer2String(s.result)),
                            (u = t.isSvg(c)
                              ? "image/svg+xml"
                              : t.getMimeType(i, c, L.type))),
                          (o = { name: U, type: u }),
                          (D = M(u, "")),
                          (F = B(u, "")),
                          (j = R(u, "")),
        ...
        cancel: function () {
          var t,
            ...
            r = i.length;
          if (r > 0)
            for (t = 0; r > t; t += 1) (n.cancelling = !0), i[t].abort();
          return (
            ...
            return (
              ...
              i._hasInitialPreview()
                ...
                : (i._getThumbs().each(function () {
                  ...
                  i.isAjaxUpload && (i.previewCache.data = {}),
                  i.$preview.html(""),
                  (n =
                    !i.overwriteInitial && i.initialCaption.length > 0
                      ? i.initialCaption
                      : ""),
                  i.$caption.attr("title", "").val(n),
                  t.addCss(i.$container, "file-input-new"),
                  i._validateDefaultPreview()),
              0 === i.$container.find(t.FRAMES).length &&
                (i._initCaption() ||
                  i.$captionContainer.removeClass("icon-visible")),
              i._hideFileIcon(),
        ...
        reset: function () {
          ...
          if (e._raise("filereset"))
            return (
              ...
              (e.getFrames().length || e.dropZoneEnabled) &&
                e.$container.removeClass("file-input-new"),
              e.clearStack(),
              (e.formdata = {}),
        ...
        upload: function () {
          var n,
            ...
            r,
            o = this,
            a = o.getFileStack().length,
            s = !e.isEmptyObject(o._getExtraData());
          if (o.isAjaxUpload && !o.isDisabled && o._isFileSelectionValid(a)) {
            if ((o._resetUpload(), 0 === a && !s))
              return void o._showUploadError(o.msgUploadEmpty);
            if (
              (o.$progress.show(),
              (o.uploadCount = 0),
              (o.uploadStatus = {}),
              ...
              return void o._uploadExtraOnly();
            if (
              ((r = o.filestack.length), (o.hasInitData = !1), !o.uploadAsync)
            )
              return o._uploadBatch(), o.$element;
            for (
              i = o._getOutData(),
                o._raise("filebatchpreupload", [i]),
                o.fileBatchCompleted = !1,
                o.uploadCache = {
                  content: [],
                  config: [],
                  tags: [],
                ...
                o.uploadAsyncCount = o.getFileStack().length,
                n = 0;
              r > n;
              n++
            )
              (o.uploadCache.content[n] = null),
                (o.uploadCache.config[n] = null),
                (o.uploadCache.tags[n] = null);
            for (
              o.$preview.find(".file-preview-initial").removeClass(t.SORT_CSS),
                o._initSortable(),
                o.cacheInitialPreview = o.getPreview(),
                n = 0;
              r > n;
              n++
            )
              o.filestack[n] && o._uploadSingle(n, !0);
          }
        },
        destroy: function () {
          var t = this,
          ...
          return (
            ...
            t._cleanup(),
            t._initPreviewCache(),
            r.insertBefore(i).off(o).removeData(),
            i.off().remove(),
            r
          );
        },
        refresh: function (n) {
          ...
          return (
            (n =
              "object" != typeof n || t.isEmpty(n)
                ? i.options
                : e.extend(!0, {}, i.options, n)),
            i._init(n, !0),
            i._listen(),
            r
          );
        ...
        getFrames: function (n) {
          ...
          return (
            (n = n || ""),
            (i = r.$preview.find(t.FRAMES + n)),
            r.reversePreviewOrder && (i = e(i.get().reverse())),
            i
          );
        },
        getPreview: function () {
            ...
            this.each(function () {
              var a,
                ...
                f =
                  ...
                  "en";
              l ||
                (u && (p = e.fn.fileinputThemes[u] || {}),
                "en" === f ||
                  t.isEmpty(e.fn.fileinputLocales[f]) ||
                  (d = e.fn.fileinputLocales[f] || {}),
                (a = e.extend(
                  !0,
                  {},
                ...
                (l = new n(this, a)),
                s.data("fileinput", l)),
                "string" == typeof i && o.push(l[i].apply(l, r));
            }),
            o.length)
          ) {
            case 0:
          ...
          function (i, r, o) {
            ...
            (o.default =
              ...
              u =
                function () {
                  ...
                  if (
                    ...
                    return (
                      p.logStr("SweetAlert expects at least 1 attribute!"), !1
                    );
                  ...
                  switch (typeof r) {
                    ...
                    case "object":
                      ...
                      (o.confirmButtonText = o.showCancelButton
                        ? "Confirm"
                        : y.default.confirmButtonText),
                        (o.confirmButtonText = i("confirmButtonText")),
              ...
              (c.close = u.close =
                function () {
                  var i = f.getModal();
                  d.fadeOut(f.getOverlay(), 5),
                    d.fadeOut(i, 5),
                    d.removeClass(i, "showSweetAlert"),
                    d.addClass(i, "hideSweetAlert"),
                    d.removeClass(i, "visible");
                  var r = i.querySelector(".sa-icon.sa-success");
                  d.removeClass(r, "animate"),
                    d.removeClass(
                      r.querySelector(".sa-tip"),
                      "animateSuccessTip"
                    ),
                    d.removeClass(
                      r.querySelector(".sa-long"),
                      "animateSuccessLong"
                    );
                  var o = i.querySelector(".sa-icon.sa-error");
                  d.removeClass(o, "animateErrorIcon"),
                    d.removeClass(
                      o.querySelector(".sa-x-mark"),
                      "animateXMark"
                    );
                  var a = i.querySelector(".sa-icon.sa-warning");
                  return (
                    d.removeClass(a, "pulseWarning"),
                    d.removeClass(
                      a.querySelector(".sa-body"),
                      "pulseWarningIns"
                    ),
                    d.removeClass(
                      a.querySelector(".sa-dot"),
                      "pulseWarningIns"
                    ),
                    setTimeout(function () {
              ...
              (c.showInputError = u.showInputError =
                function (e) {
                  var t = f.getModal(),
              ...
              (c.resetInputError = u.resetInputError =
                function (e) {
              ...
              (c.disableButtons = u.disableButtons =
                function () {
                  var e = f.getModal(),
              ...
              (c.enableButtons = u.enableButtons =
                function () {
                  var e = f.getModal(),
                    t = e.querySelector("button.confirm"),
                    n = e.querySelector("button.cancel");
            ...
            var r = t("./utils"),
              ...
              a = function (t, n, i) {
                ...
                var c,
                  ...
                  v =
                    n.doneFunction &&
                    "true" === i.getAttribute("data-has-done-function");
                switch (
                  (h &&
                    n.confirmButtonColor &&
                    ((c = n.confirmButtonColor),
                    (u = r.colorLuminance(c, -0.04)),
                    (d = r.colorLuminance(c, -0.14))),
                  p.type)
                ) {
                  case "mouseover":
                    a(u);
            ...
            var o = t("./handle-dom"),
              ...
              s = function (t, i, r) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(l)) {
                  for (
                    var p = s.target || s.srcElement, f = -1, h = 0;
                    h < d.length;
                    h++
                  )
                    if (p === d[h]) {
          ...
          function (e, t, i) {
            ...
            var r = e("./utils"),
              ...
              l = function (e) {
                ...
                if (
                  (a.hide(t.querySelectorAll(".sa-icon")), e.type && !r.isIE8())
                ) {
                  var p = (function () {
                    ...
                    var l = ["success", "error", "warning", "info"],
                      c = n;
                    -1 !== l.indexOf(e.type) &&
                      ((c = t.querySelector(".sa-icon.sa-" + e.type)),
                      a.show(c));
                    var u = o.getInput();
                    switch (e.type) {
                      case "success":
                        a.addClass(c, "animate"),
                          a.addClass(
                            c.querySelector(".sa-tip"),
                            "animateSuccessTip"
                          ),
                          a.addClass(
                            c.querySelector(".sa-long"),
                            "animateSuccessLong"
                          );
                        break;
                      case "error":
                      ...
                      case "warning":
                        a.addClass(c, "pulseWarning"),
                          a.addClass(
                            c.querySelector(".sa-body"),
                            "pulseWarningIns"
                          ),
                          a.addClass(
                            c.querySelector(".sa-dot"),
                            "pulseWarningIns"
                          );
                        break;
                      case "input":
                ...
                t.setAttribute("data-has-cancel-button", e.showCancelButton),
                  ...
                  e.showConfirmButton
                    ...
                    : a.hide(u),
                  e.cancelButtonText &&
                    (c.innerHTML = a.escapeHtml(e.cancelButtonText)),
                  e.confirmButtonText &&
                    (u.innerHTML = a.escapeHtml(e.confirmButtonText)),
                  e.confirmButtonColor &&
                    ((u.style.backgroundColor = e.confirmButtonColor),
      ...
      (n.prototype = {
        ...
        _parseValue: function (e) {
          var t = this,
            n = parseFloat(e);
          return (
            isNaN(n) && (n = t.clearValue),
            !t.zeroAsNull || (0 !== n && "0" !== n) ? n : null
          );
        },
        ...
        _initSlider: function (e) {
          var n = this,
            i = n.$element.val();
          (n.initialValue = t.isEmpty(i) ? 0 : i),
            n._setDefault("min", n._parseAttr("min", e)),
            n._setDefault("max", n._parseAttr("max", e)),
            n._setDefault("step", n._parseAttr("step", e)),
            (isNaN(n.min) || t.isEmpty(n.min)) && (n.min = t.DEFAULT_MIN),
            (isNaN(n.max) || t.isEmpty(n.max)) && (n.max = t.DEFAULT_MAX),
            (isNaN(n.step) || t.isEmpty(n.step) || 0 === n.step) &&
              (n.step = t.DEFAULT_STEP),
            (n.diff = n.max - n.min);
        },
        _initHighlight: function (e) {
          var t,
            ...
            i = n._getCaption();
          e || (e = n.$element.val()),
            (t = n.getWidthFromValue(e) + "%"),
            n.$filledStars.width(t),
            (n.cache = { caption: i, width: t, val: e });
        },
        ...
        _checkDisabled: function () {
          var e = this,
            ...
            n = e.options;
          (e.disabled =
            void 0 === n.disabled ? t.attr("disabled") || !1 : n.disabled),
            (e.readonly =
              void 0 === n.readonly ? t.attr("readonly") || !1 : n.readonly),
        ...
        _generateRating: function () {
          var n,
            ...
            o = this,
            a = o.$element;
          (i = o.$container = e(document.createElement("div")).insertBefore(a)),
            t.addCss(i, o._getContainerCss()),
            (o.$rating = n =
              e(document.createElement("div"))
                .attr("class", "rating-stars")
                .appendTo(i)
                .append(o._getStars("empty"))
                .append(o._getStars("filled"))),
            (o.$emptyStars = n.find(".empty-stars")),
            (o.$filledStars = n.find(".filled-stars")),
            o._renderCaption(),
            o._renderClear(),
            o._initHighlight(),
            o._initCaptionTitle(),
            ...
            o.rtl &&
              ((r = Math.max(
                o.$emptyStars.outerWidth(),
                o.$filledStars.outerWidth()
              )),
              o.$emptyStars.width(r)),
            a.appendTo(n);
        },
        ...
        _renderCaption: function () {
          var n,
            i = this,
            r = i.$element.val(),
            o = i.captionElement ? e(i.captionElement) : "";
          if (i.showCaption) {
            if (((n = i.fetchCaption(r)), o && o.length))
              return t.addCss(o, "caption"), o.html(n), void (i.$caption = o);
            i._addContent("caption", '<div class="caption">' + n + "</div>"),
        ...
        _renderClear: function () {
          var n,
            i = this,
            r = i.clearElement ? e(i.clearElement) : "";
          if (i.showClear) {
            if (((n = i._getClearClass()), r.length))
              return (
                t.addCss(r, n),
        ...
        _toggleHover: function (e) {
          ...
          e &&
            (r.hoverChangeStars &&
              ...
              (n = e.val <= r.clearValue ? t + "%" : e.width),
              r.$filledStars.css("width", n)),
            r.hoverChangeCaption &&
              (i =
                e.val <= r.clearValue
                  ? r.fetchCaption(r.clearValue)
                  : e.caption) &&
              r._setCaption(i + ""));
        },
        _init: function (t) {
          var n,
            i = this,
            r = i.$element.addClass("rating-input");
          return (
            (i.options = t),
            e.each(t, function (e, t) {
              i[e] = t;
            }),
            (i.rtl || "rtl" === r.attr("dir")) &&
              ((i.rtl = !0), r.attr("dir", "rtl")),
            (i.starClicked = !1),
            (i.clearClicked = !1),
            i._initSlider(t),
            i._checkDisabled(),
            i.displayOnly &&
              ...
              (i.showClear = !1),
              (i.hoverEnabled = !1),
              (i.hoverChangeCaption = !1),
              (i.hoverChangeStars = !1)),
            i._generateRating(),
            i._initEvents(),
            i._listen(),
            (n = i._parseValue(r.val())),
            r.val(n),
        ...
        _initCaptionTitle: function () {
          var t,
            n = this;
          n.showCaptionAsTitle &&
            ((t = n.fetchCaption(n.$element.val())),
            n.$rating.attr("title", e(t).text()));
        },
          ...
          e.events = {
            ...
            initTouch: function (n) {
              ...
              ("ontouchstart" in window ||
                ...
                !e.inactive &&
                ((i = n.originalEvent),
                (r = t.isEmpty(i.touches) ? i.changedTouches : i.touches),
                (o = e.events._getTouchPosition(r[0])),
                "touchend" === n.type
                  ? (e._setStars(o),
                    ...
                    (e.starClicked = !0))
                  : ((a = e.calculate(o)),
                    (s = a.val <= d ? e.fetchCaption(d) : a.caption),
                    (l = e.getWidthFromValue(d)),
                    (c = a.val <= d ? l + "%" : a.width),
                    e._setCaption(s),
            ...
            starClick: function (t) {
              ...
              e.events._listenClick(t, function (t) {
                return (
                  !e.inactive &&
                  ((n = e.events._getTouchPosition(t)),
                  e._setStars(n),
                  (i = [e.$element.val(), e._getCaption()]),
                  e._trigChange(i),
            ...
            starMouseMove: function (t) {
              ...
              e.events._noMouseAction(t) ||
                ...
                (i = e.calculate(n)),
                e._toggleHover(i),
                e.$element.trigger("rating:hover", [
                  i.val,
                  i.caption,
                  "stars",
                ]));
            ...
            clearMouseMove: function (t) {
              ...
              !e.events._noMouseAction(t) &&
                ...
                (n =
                  ...
                  "</span>"),
                (i = e.clearValue),
                (r = e.getWidthFromValue(i) || 0),
                (o = { caption: n, width: r, val: i }),
                e._toggleHover(o),
                e.$element.trigger("rating:hover", [i, n, "clear"]));
            },
        ...
        _listen: function () {
          ...
          return (
            t.handler(
              ...
              e.proxy(s.initTouch, n)
            ),
            t.handler(o, "click touchstart", e.proxy(s.starClick, n)),
            t.handler(o, "mousemove", e.proxy(s.starMouseMove, n)),
            t.handler(o, "mouseleave", e.proxy(s.starMouseLeave, n)),
            n.showClear &&
              a.length &&
              (t.handler(a, "click touchstart", e.proxy(s.clearClick, n)),
              t.handler(a, "mousemove", e.proxy(s.clearMouseMove, n)),
              t.handler(a, "mouseleave", e.proxy(s.clearMouseLeave, n))),
            r.length && t.handler(r, "reset", e.proxy(s.resetForm, n), !0),
            i
          );
        },
        _getStars: function (e) {
          var t,
            n = this,
            i = '<span class="' + e + '-stars">';
          for (t = 1; t <= n.stars; t++)
            i += '<span class="star">' + n[e + "Star"] + "</span>";
          return i + "</span>";
        },
        _setStars: function (e) {
          ...
          return (
            i.val(r),
            t.$filledStars.css("width", n.width),
            t._setCaption(n.caption),
            (t.cache = n),
            i
          );
        },
        ...
        calculate: function (e) {
          var n = this,
            ...
            r = arguments.length ? n.getValueFromPosition(e) : i,
            o = n.fetchCaption(r),
            a = n.getWidthFromValue(r);
        ...
        getValueFromPosition: function (e) {
          var n,
            i,
            r = this,
            o = t.getDecimalPlaces(r.step),
            a = r.$rating.width();
          return (
            (i = (r.diff * e) / (a * r.step)),
            (i = r.rtl ? Math.floor(i) : Math.ceil(i)),
            (n = t.applyPrecision(parseFloat(r.min + i * r.step), o)),
            (n = Math.max(Math.min(n, r.max), r.min)),
            r.rtl ? r.max - n : n
          );
        },
        ...
        fetchCaption: function (e) {
          var n,
            ...
            a,
            s = this,
            l = parseFloat(e) || s.clearValue,
            c = s.starCaptions,
            u = s.starCaptionClasses,
            d = s.getWidthFromValue(l);
          return (
            l &&
              l !== s.clearValue &&
              (l = t.applyPrecision(l, t.getDecimalPlaces(s.step))),
            (o = "function" == typeof u ? u(l, d) : u[l]),
            (r = "function" == typeof c ? c(l, d) : c[l]),
            (i = t.isEmpty(r) ? s.defaultCaption.replace(/\{rating}/g, l) : r),
            (n = t.isEmpty(o) ? s.clearCaptionClass : o),
            (a = l === s.clearValue ? s.clearCaption : i),
            '<span class="' + n + '">' + a + "</span>"
          );
        },
        destroy: function () {
          var n = this,
            i = n.$element;
          return (
            t.isEmpty(n.$container) || n.$container.before(i).remove(),
            e.removeData(i.get(0)),
